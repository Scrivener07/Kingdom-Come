...
namespace KingdomCome.Library.Tables
{
	public static class Definition
	{
		...
		public static int ReadTableVector3(this BinaryReader reader)
		{
			// Vec3	96 bit(3 * 32 bit) vec3
			return 0;
		}

		public static int ReadTableQuaternion(this BinaryReader reader)
		{
			// Quat	128 bit(4 * 32 bit)    quat
			return 0;
		}

		public static int ReadTableQuaternionT(this BinaryReader reader)
		{
