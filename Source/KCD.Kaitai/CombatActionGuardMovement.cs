...
{
    public partial class CombatActionGuardMovement : KaitaiStruct
    {
        public static CombatActionGuardMovement FromFile(string fileName)
        {
            return new CombatActionGuardMovement(new KaitaiStream(fileName));
        }

        public CombatActionGuardMovement(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionGuardMovement p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionGuardMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionGuardMovement m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CombatActionGuardMovement M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionGuardMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CombatActionGuardMovement p__parent = null, CombatActionGuardMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private int _mnTags;
            private CombatActionGuardMovement m_root;
            private CombatActionGuardMovement m_parent;
            ...
            public CombatActionGuardMovement M_Root { get { return m_root; } }
            public CombatActionGuardMovement M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionGuardMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, CombatActionGuardMovement.Row p__parent = null, CombatActionGuardMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionGuardMovement m_root;
            private CombatActionGuardMovement.Row m_parent;
            public byte[] QuattType { get { return _quattType; } }
            public CombatActionGuardMovement M_Root { get { return m_root; } }
            public CombatActionGuardMovement.Row M_Parent { get { return m_parent; } }
        }
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CombatActionGuardMovement p__parent = null, CombatActionGuardMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionGuardMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionGuardMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
