...
{
    public partial class RecipeIngredient : KaitaiStruct
    {
        public static RecipeIngredient FromFile(string fileName)
        {
            return new RecipeIngredient(new KaitaiStream(fileName));
        }

        public RecipeIngredient(KaitaiStream p__io, KaitaiStruct p__parent = null, RecipeIngredient p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, RecipeIngredient.Row p__parent = null, RecipeIngredient p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private RecipeIngredient m_root;
            private RecipeIngredient.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public RecipeIngredient M_Root { get { return m_root; } }
            public RecipeIngredient.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, RecipeIngredient p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, RecipeIngredient p__parent = null, RecipeIngredient p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _quantity = m_io.ReadS4le();
            }
            private int _recipeId;
            private Uuid _itemId;
            private int _quantity;
            private RecipeIngredient m_root;
            private RecipeIngredient m_parent;
            public int RecipeId { get { return _recipeId; } }
            public Uuid ItemId { get { return _itemId; } }
            public int Quantity { get { return _quantity; } }
            public RecipeIngredient M_Root { get { return m_root; } }
            public RecipeIngredient M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, RecipeIngredient p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, RecipeIngredient p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, RecipeIngredient p__parent = null, RecipeIngredient p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, RecipeIngredient p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, RecipeIngredient p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
