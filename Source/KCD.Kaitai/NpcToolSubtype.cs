...
{
    public partial class NpcToolSubtype : KaitaiStruct
    {
        public static NpcToolSubtype FromFile(string fileName)
        {
            return new NpcToolSubtype(new KaitaiStream(fileName));
        }

        public NpcToolSubtype(KaitaiStream p__io, KaitaiStruct p__parent = null, NpcToolSubtype p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, NpcToolSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private NpcToolSubtype m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public NpcToolSubtype M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, NpcToolSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, NpcToolSubtype p__parent = null, NpcToolSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _npcToolSubtypeName = m_io.ReadS4le();
            }
            private int _npcToolSubtypeId;
            private int _npcToolSubtypeName;
            private NpcToolSubtype m_root;
            private NpcToolSubtype m_parent;
            public int NpcToolSubtypeId { get { return _npcToolSubtypeId; } }
            public int NpcToolSubtypeName { get { return _npcToolSubtypeName; } }
            public NpcToolSubtype M_Root { get { return m_root; } }
            public NpcToolSubtype M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, NpcToolSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, NpcToolSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, NpcToolSubtype p__parent = null, NpcToolSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, NpcToolSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, NpcToolSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
