...
{
    public partial class ConsumableItem : KaitaiStruct
    {
        public static ConsumableItem FromFile(string fileName)
        {
            return new ConsumableItem(new KaitaiStream(fileName));
        }

        public ConsumableItem(KaitaiStream p__io, KaitaiStruct p__parent = null, ConsumableItem p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, ConsumableItem.Row p__parent = null, ConsumableItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private ConsumableItem m_root;
            private ConsumableItem.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public ConsumableItem M_Root { get { return m_root; } }
            public ConsumableItem.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, ConsumableItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, ConsumableItem p__parent = null, ConsumableItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _buffId = new Uuid(m_io, this, m_root);
            }
            private Uuid _itemId;
            private Uuid _buffId;
            private ConsumableItem m_root;
            private ConsumableItem m_parent;
            public Uuid ItemId { get { return _itemId; } }
            public Uuid BuffId { get { return _buffId; } }
            public ConsumableItem M_Root { get { return m_root; } }
            public ConsumableItem M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, ConsumableItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, ConsumableItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, ConsumableItem p__parent = null, ConsumableItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, ConsumableItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, ConsumableItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
