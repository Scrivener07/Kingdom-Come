...
{
    public partial class CreditRole : KaitaiStruct
    {
        public static CreditRole FromFile(string fileName)
        {
            return new CreditRole(new KaitaiStream(fileName));
        }

        public CreditRole(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditRole p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditRole p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CreditRole m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CreditRole M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditRole p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CreditRole p__parent = null, CreditRole p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _creditRoleName = m_io.ReadS4le();
                _orderBy = m_io.ReadS4le();
                _creditLayoutId = m_io.ReadS4le();
            }
            private int _creditRoleId;
            private int _creditRoleName;
            private int _orderBy;
            private int _creditLayoutId;
            private CreditRole m_root;
            private CreditRole m_parent;
            public int CreditRoleId { get { return _creditRoleId; } }
            public int CreditRoleName { get { return _creditRoleName; } }
            public int OrderBy { get { return _orderBy; } }
            public int CreditLayoutId { get { return _creditLayoutId; } }
            public CreditRole M_Root { get { return m_root; } }
            public CreditRole M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditRole p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditRole p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CreditRole p__parent = null, CreditRole p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditRole p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditRole p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
