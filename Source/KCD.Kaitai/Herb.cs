...
{
    public partial class Herb : KaitaiStruct
    {
        public static Herb FromFile(string fileName)
        {
            return new Herb(new KaitaiStream(fileName));
        }

        public Herb(KaitaiStream p__io, KaitaiStruct p__parent = null, Herb p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, Herb.Row p__parent = null, Herb p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private Herb m_root;
            private Herb.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public Herb M_Root { get { return m_root; } }
            public Herb.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, Herb p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, Herb p__parent = null, Herb p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _latinName = m_io.ReadS4le();
                _uiDesc = m_io.ReadS4le();
                _uiEffect = m_io.ReadS4le();
                _uiOccur = m_io.ReadS4le();
                _element1Id = m_io.ReadS4le();
                _element2Id = m_io.ReadS4le();
                _poisonous = m_io.ReadS1();
            }
            private Uuid _itemId;
            private int _latinName;
            private int _uiDesc;
            private int _uiEffect;
            private int _uiOccur;
            private int _element1Id;
            private int _element2Id;
            private sbyte _poisonous;
            private Herb m_root;
            private Herb m_parent;
            public Uuid ItemId { get { return _itemId; } }
            public int LatinName { get { return _latinName; } }
            public int UiDesc { get { return _uiDesc; } }
            public int UiEffect { get { return _uiEffect; } }
            public int UiOccur { get { return _uiOccur; } }
            public int Element1Id { get { return _element1Id; } }
            public int Element2Id { get { return _element2Id; } }
            public sbyte Poisonous { get { return _poisonous; } }
            public Herb M_Root { get { return m_root; } }
            public Herb M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, Herb p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, Herb p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, Herb p__parent = null, Herb p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, Herb p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, Herb p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
