...
{
    public partial class InventoriesDay1patch : KaitaiStruct
    {
        public static InventoriesDay1patch FromFile(string fileName)
        {
            return new InventoriesDay1patch(new KaitaiStream(fileName));
        }

        public InventoriesDay1patch(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoriesDay1patch p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, InventoriesDay1patch.Row p__parent = null, InventoriesDay1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private InventoriesDay1patch m_root;
            private InventoriesDay1patch.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public InventoriesDay1patch M_Root { get { return m_root; } }
            public InventoriesDay1patch.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoriesDay1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, InventoriesDay1patch p__parent = null, InventoriesDay1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private int _amount;
            private InventoriesDay1patch m_root;
            private InventoriesDay1patch m_parent;
            public Uuid ItemGuid { get { return _itemGuid; } }
            public int Amount { get { return _amount; } }
            public InventoriesDay1patch M_Root { get { return m_root; } }
            public InventoriesDay1patch M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoriesDay1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoriesDay1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, InventoriesDay1patch p__parent = null, InventoriesDay1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoriesDay1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoriesDay1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
