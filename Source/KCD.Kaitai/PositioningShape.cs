...
{
    public partial class PositioningShape : KaitaiStruct
    {
        public static PositioningShape FromFile(string fileName)
        {
            return new PositioningShape(new KaitaiStream(fileName));
        }

        public PositioningShape(KaitaiStream p__io, KaitaiStruct p__parent = null, PositioningShape p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, PositioningShape.Row p__parent = null, PositioningShape p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private PositioningShape m_root;
            private PositioningShape.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public PositioningShape M_Root { get { return m_root; } }
            public PositioningShape.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, PositioningShape p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, PositioningShape p__parent = null, PositioningShape p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _positioningShapeId = new Uuid(m_io, this, m_root);
                _positioningShapeName = m_io.ReadS4le();
            }
            private Uuid _positioningShapeId;
            private int _positioningShapeName;
            private PositioningShape m_root;
            private PositioningShape m_parent;
            public Uuid PositioningShapeId { get { return _positioningShapeId; } }
            public int PositioningShapeName { get { return _positioningShapeName; } }
            public PositioningShape M_Root { get { return m_root; } }
            public PositioningShape M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, PositioningShape p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, PositioningShape p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, PositioningShape p__parent = null, PositioningShape p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, PositioningShape p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, PositioningShape p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
