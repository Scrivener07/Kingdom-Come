...
{
    public partial class AnimFragmentDoNotInterrupt : KaitaiStruct
    {
        public static AnimFragmentDoNotInterrupt FromFile(string fileName)
        {
            return new AnimFragmentDoNotInterrupt(new KaitaiStream(fileName));
        }

        public AnimFragmentDoNotInterrupt(KaitaiStream p__io, KaitaiStruct p__parent = null, AnimFragmentDoNotInterrupt p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, AnimFragmentDoNotInterrupt p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AnimFragmentDoNotInterrupt m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public AnimFragmentDoNotInterrupt M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, AnimFragmentDoNotInterrupt p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, AnimFragmentDoNotInterrupt p__parent = null, AnimFragmentDoNotInterrupt p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _startTime = m_io.ReadF4le();
                _endTime = m_io.ReadF4le();
            ...
            private AnimFragmentDoNotInterrupt m_root;
            private AnimFragmentDoNotInterrupt m_parent;
            ...
            public AnimFragmentDoNotInterrupt M_Root { get { return m_root; } }
            public AnimFragmentDoNotInterrupt M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, AnimFragmentDoNotInterrupt p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, AnimFragmentDoNotInterrupt p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, AnimFragmentDoNotInterrupt p__parent = null, AnimFragmentDoNotInterrupt p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, AnimFragmentDoNotInterrupt p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, AnimFragmentDoNotInterrupt p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
