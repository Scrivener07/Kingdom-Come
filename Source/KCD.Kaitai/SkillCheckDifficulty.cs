...
{
    public partial class SkillCheckDifficulty : KaitaiStruct
    {
        public static SkillCheckDifficulty FromFile(string fileName)
        {
            return new SkillCheckDifficulty(new KaitaiStream(fileName));
        }

        public SkillCheckDifficulty(KaitaiStream p__io, KaitaiStruct p__parent = null, SkillCheckDifficulty p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, SkillCheckDifficulty p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SkillCheckDifficulty p__parent = null, SkillCheckDifficulty p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _skillCheckDifficultyName = m_io.ReadS4le();
                _speechDifference = m_io.ReadS4le();
                _badassnessDifference = m_io.ReadF4le();
                _charismaDifference = m_io.ReadS4le();
            }
            private int _skillCheckDifficultyId;
            private int _skillCheckDifficultyName;
            private int _speechDifference;
            private float _badassnessDifference;
            private int _charismaDifference;
            private SkillCheckDifficulty m_root;
            private SkillCheckDifficulty m_parent;
            public int SkillCheckDifficultyId { get { return _skillCheckDifficultyId; } }
            public int SkillCheckDifficultyName { get { return _skillCheckDifficultyName; } }
            public int SpeechDifference { get { return _speechDifference; } }
            public float BadassnessDifference { get { return _badassnessDifference; } }
            public int CharismaDifference { get { return _charismaDifference; } }
            public SkillCheckDifficulty M_Root { get { return m_root; } }
            public SkillCheckDifficulty M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SkillCheckDifficulty p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SkillCheckDifficulty p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SkillCheckDifficulty p__parent = null, SkillCheckDifficulty p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SkillCheckDifficulty p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SkillCheckDifficulty p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
