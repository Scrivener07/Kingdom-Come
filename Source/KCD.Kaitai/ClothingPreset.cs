...
{
    public partial class ClothingPreset : KaitaiStruct
    {
        public static ClothingPreset FromFile(string fileName)
        {
            return new ClothingPreset(new KaitaiStream(fileName));
        }

        public ClothingPreset(KaitaiStream p__io, KaitaiStruct p__parent = null, ClothingPreset p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, ClothingPreset.Row p__parent = null, ClothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private ClothingPreset m_root;
            private ClothingPreset.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public ClothingPreset M_Root { get { return m_root; } }
            public ClothingPreset.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, ClothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, ClothingPreset p__parent = null, ClothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _clothingPresetId = new Uuid(m_io, this, m_root);
                _clothingPresetName = m_io.ReadS4le();
                _socialClassId = m_io.ReadS4le();
                _wealthLevel = m_io.ReadS4le();
                _genderId = m_io.ReadS4le();
                _prefersHoodOn = m_io.ReadS1();
            }
            private int _computerName;
            private int _timestamp;
            private Uuid _clothingPresetId;
            private int _clothingPresetName;
            private int _socialClassId;
            private int _wealthLevel;
            private int _genderId;
            private sbyte _prefersHoodOn;
            private ClothingPreset m_root;
            private ClothingPreset m_parent;
            public int ComputerName { get { return _computerName; } }
            public int Timestamp { get { return _timestamp; } }
            public Uuid ClothingPresetId { get { return _clothingPresetId; } }
            public int ClothingPresetName { get { return _clothingPresetName; } }
            ...
            public sbyte PrefersHoodOn { get { return _prefersHoodOn; } }
            public ClothingPreset M_Root { get { return m_root; } }
            public ClothingPreset M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, ClothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, ClothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, ClothingPreset p__parent = null, ClothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, ClothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, ClothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
