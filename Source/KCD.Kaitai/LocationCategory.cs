...
{
    public partial class LocationCategory : KaitaiStruct
    {
        public static LocationCategory FromFile(string fileName)
        {
            return new LocationCategory(new KaitaiStream(fileName));
        }

        public LocationCategory(KaitaiStream p__io, KaitaiStruct p__parent = null, LocationCategory p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, LocationCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private LocationCategory m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public LocationCategory M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, LocationCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, LocationCategory p__parent = null, LocationCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _locationCategoryName = m_io.ReadS4le();
            }
            private int _locationCategoryId;
            private int _locationCategoryName;
            private LocationCategory m_root;
            private LocationCategory m_parent;
            public int LocationCategoryId { get { return _locationCategoryId; } }
            public int LocationCategoryName { get { return _locationCategoryName; } }
            public LocationCategory M_Root { get { return m_root; } }
            public LocationCategory M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, LocationCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, LocationCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, LocationCategory p__parent = null, LocationCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, LocationCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, LocationCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
