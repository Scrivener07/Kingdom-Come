...
{
    public partial class PerkBuffOverride : KaitaiStruct
    {
        public static PerkBuffOverride FromFile(string fileName)
        {
            return new PerkBuffOverride(new KaitaiStream(fileName));
        }

        public PerkBuffOverride(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkBuffOverride p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, PerkBuffOverride.Row p__parent = null, PerkBuffOverride p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private PerkBuffOverride m_root;
            private PerkBuffOverride.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public PerkBuffOverride M_Root { get { return m_root; } }
            public PerkBuffOverride.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkBuffOverride p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, PerkBuffOverride p__parent = null, PerkBuffOverride p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _perkId = new Uuid(m_io, this, m_root);
                _sourceBuffId = new Uuid(m_io, this, m_root);
                _targetBuffId = new Uuid(m_io, this, m_root);
            }
            private Uuid _perkId;
            private Uuid _sourceBuffId;
            private Uuid _targetBuffId;
            private PerkBuffOverride m_root;
            private PerkBuffOverride m_parent;
            public Uuid PerkId { get { return _perkId; } }
            public Uuid SourceBuffId { get { return _sourceBuffId; } }
            public Uuid TargetBuffId { get { return _targetBuffId; } }
            public PerkBuffOverride M_Root { get { return m_root; } }
            public PerkBuffOverride M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkBuffOverride p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkBuffOverride p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, PerkBuffOverride p__parent = null, PerkBuffOverride p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkBuffOverride p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkBuffOverride p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
