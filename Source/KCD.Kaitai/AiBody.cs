...
{
    public partial class AiBody : KaitaiStruct
    {
        public static AiBody FromFile(string fileName)
        {
            return new AiBody(new KaitaiStream(fileName));
        }

        public AiBody(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, AiBody.Row p__parent = null, AiBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AiBody m_root;
            private AiBody.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public AiBody M_Root { get { return m_root; } }
            public AiBody.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, AiBody p__parent = null, AiBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _aiBodyName = m_io.ReadS4le();
            }
            private Uuid _aiBodyId;
            private int _aiBodyName;
            private AiBody m_root;
            private AiBody m_parent;
            public Uuid AiBodyId { get { return _aiBodyId; } }
            public int AiBodyName { get { return _aiBodyName; } }
            public AiBody M_Root { get { return m_root; } }
            public AiBody M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, AiBody p__parent = null, AiBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
