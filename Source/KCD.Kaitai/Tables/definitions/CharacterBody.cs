...
{
    public partial class CharacterBody : KaitaiStruct
    {
        public static CharacterBody FromFile(string fileName)
        {
            return new CharacterBody(new KaitaiStream(fileName));
        }

        public CharacterBody(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterBody p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, CharacterBody.Row p__parent = null, CharacterBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CharacterBody m_root;
            private CharacterBody.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CharacterBody M_Root { get { return m_root; } }
            public CharacterBody.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CharacterBody p__parent = null, CharacterBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _characterBodyName = m_io.ReadS4le();
                ...
                _characterBodyArchetypeId = m_io.ReadS4le();
            }
            private int _computerName;
            private int _timestamp;
            private Uuid _characterBodyId;
            private int _characterBodyName;
            private int _model;
            ...
            private int _raceId;
            private int _characterBodyArchetypeId;
            private CharacterBody m_root;
            private CharacterBody m_parent;
            ...
            public int CharacterBodyName { get { return _characterBodyName; } }
            ...
            public int CharacterBodyArchetypeId { get { return _characterBodyArchetypeId; } }
            public CharacterBody M_Root { get { return m_root; } }
            public CharacterBody M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CharacterBody p__parent = null, CharacterBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterBody p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
