...
{
    public partial class InventoryPreset2item : KaitaiStruct
    {
        public static InventoryPreset2item FromFile(string fileName)
        {
            return new InventoryPreset2item(new KaitaiStream(fileName));
        }

        public InventoryPreset2item(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoryPreset2item p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, InventoryPreset2item.Row p__parent = null, InventoryPreset2item p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private InventoryPreset2item m_root;
            private InventoryPreset2item.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public InventoryPreset2item M_Root { get { return m_root; } }
            public InventoryPreset2item.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoryPreset2item p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, InventoryPreset2item p__parent = null, InventoryPreset2item p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _inventoryPresetId = new Uuid(m_io, this, m_root);
            ...
            private Uuid _inventoryPresetId;
            ...
            private InventoryPreset2item m_root;
            private InventoryPreset2item m_parent;
            public Uuid InventoryPresetId { get { return _inventoryPresetId; } }
            ...
            public InventoryPreset2item M_Root { get { return m_root; } }
            public InventoryPreset2item M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoryPreset2item p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoryPreset2item p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, InventoryPreset2item p__parent = null, InventoryPreset2item p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoryPreset2item p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoryPreset2item p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
