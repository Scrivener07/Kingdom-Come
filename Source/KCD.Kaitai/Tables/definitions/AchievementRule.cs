...
{
    public partial class AchievementRule : KaitaiStruct
    {
        public static AchievementRule FromFile(string fileName)
        {
            return new AchievementRule(new KaitaiStream(fileName));
        }

        public AchievementRule(KaitaiStream p__io, KaitaiStruct p__parent = null, AchievementRule p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, AchievementRule p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AchievementRule m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public AchievementRule M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, AchievementRule p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, AchievementRule p__parent = null, AchievementRule p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _achievementRuleName = m_io.ReadS4le();
                _threshold = m_io.ReadF4le();
                _achievementRuleActionId = m_io.ReadS4le();
            }
            private int _achievementId;
            private int _statisticId;
            private int _achievementRuleName;
            private float _threshold;
            private int _achievementRuleActionId;
            private AchievementRule m_root;
            private AchievementRule m_parent;
            public int AchievementId { get { return _achievementId; } }
            public int StatisticId { get { return _statisticId; } }
            public int AchievementRuleName { get { return _achievementRuleName; } }
            public float Threshold { get { return _threshold; } }
            public int AchievementRuleActionId { get { return _achievementRuleActionId; } }
            public AchievementRule M_Root { get { return m_root; } }
            public AchievementRule M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, AchievementRule p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, AchievementRule p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, AchievementRule p__parent = null, AchievementRule p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, AchievementRule p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, AchievementRule p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
