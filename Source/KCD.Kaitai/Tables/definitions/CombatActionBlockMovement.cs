...
{
    public partial class CombatActionBlockMovement : KaitaiStruct
    {
        public static CombatActionBlockMovement FromFile(string fileName)
        {
            return new CombatActionBlockMovement(new KaitaiStream(fileName));
        }

        public CombatActionBlockMovement(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionBlockMovement p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionBlockMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionBlockMovement m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CombatActionBlockMovement M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionBlockMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CombatActionBlockMovement p__parent = null, CombatActionBlockMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _minDistance = m_io.ReadF4le();
                _maxDistance = m_io.ReadF4le();
            ...
            private int _mnTags;
            private CombatActionBlockMovement m_root;
            private CombatActionBlockMovement m_parent;
            ...
            public CombatActionBlockMovement M_Root { get { return m_root; } }
            public CombatActionBlockMovement M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionBlockMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, CombatActionBlockMovement.Row p__parent = null, CombatActionBlockMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionBlockMovement m_root;
            private CombatActionBlockMovement.Row m_parent;
            public byte[] QuattType { get { return _quattType; } }
            public CombatActionBlockMovement M_Root { get { return m_root; } }
            public CombatActionBlockMovement.Row M_Parent { get { return m_parent; } }
        }
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CombatActionBlockMovement p__parent = null, CombatActionBlockMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionBlockMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionBlockMovement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
