...
{
    public partial class SkaldObjectiveStringType : KaitaiStruct
    {
        public static SkaldObjectiveStringType FromFile(string fileName)
        {
            return new SkaldObjectiveStringType(new KaitaiStream(fileName));
        }

        public SkaldObjectiveStringType(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldObjectiveStringType p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldObjectiveStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SkaldObjectiveStringType m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public SkaldObjectiveStringType M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldObjectiveStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SkaldObjectiveStringType p__parent = null, SkaldObjectiveStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _skaldObjectiveStringTypeName = m_io.ReadS4le();
            }
            private int _skaldObjectiveStringTypeId;
            private int _skaldObjectiveStringTypeName;
            private SkaldObjectiveStringType m_root;
            private SkaldObjectiveStringType m_parent;
            public int SkaldObjectiveStringTypeId { get { return _skaldObjectiveStringTypeId; } }
            public int SkaldObjectiveStringTypeName { get { return _skaldObjectiveStringTypeName; } }
            public SkaldObjectiveStringType M_Root { get { return m_root; } }
            public SkaldObjectiveStringType M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldObjectiveStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldObjectiveStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SkaldObjectiveStringType p__parent = null, SkaldObjectiveStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldObjectiveStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldObjectiveStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
