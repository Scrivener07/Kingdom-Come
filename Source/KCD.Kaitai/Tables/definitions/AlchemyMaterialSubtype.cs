...
{
    public partial class AlchemyMaterialSubtype : KaitaiStruct
    {
        public static AlchemyMaterialSubtype FromFile(string fileName)
        {
            return new AlchemyMaterialSubtype(new KaitaiStream(fileName));
        }

        public AlchemyMaterialSubtype(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyMaterialSubtype p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyMaterialSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AlchemyMaterialSubtype m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public AlchemyMaterialSubtype M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyMaterialSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, AlchemyMaterialSubtype p__parent = null, AlchemyMaterialSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _alchemyMaterialSubtypeName = m_io.ReadS4le();
            }
            private int _alchemyMaterialSubtypeId;
            private int _alchemyMaterialSubtypeName;
            private AlchemyMaterialSubtype m_root;
            private AlchemyMaterialSubtype m_parent;
            public int AlchemyMaterialSubtypeId { get { return _alchemyMaterialSubtypeId; } }
            public int AlchemyMaterialSubtypeName { get { return _alchemyMaterialSubtypeName; } }
            public AlchemyMaterialSubtype M_Root { get { return m_root; } }
            public AlchemyMaterialSubtype M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyMaterialSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyMaterialSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, AlchemyMaterialSubtype p__parent = null, AlchemyMaterialSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyMaterialSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyMaterialSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
