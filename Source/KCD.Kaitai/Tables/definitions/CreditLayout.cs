...
{
    public partial class CreditLayout : KaitaiStruct
    {
        public static CreditLayout FromFile(string fileName)
        {
            return new CreditLayout(new KaitaiStream(fileName));
        }

        public CreditLayout(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditLayout p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditLayout p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CreditLayout m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CreditLayout M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditLayout p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CreditLayout p__parent = null, CreditLayout p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _creditLayoutName = m_io.ReadS4le();
            }
            private int _creditLayoutId;
            private int _creditLayoutName;
            private CreditLayout m_root;
            private CreditLayout m_parent;
            public int CreditLayoutId { get { return _creditLayoutId; } }
            public int CreditLayoutName { get { return _creditLayoutName; } }
            public CreditLayout M_Root { get { return m_root; } }
            public CreditLayout M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditLayout p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditLayout p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CreditLayout p__parent = null, CreditLayout p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditLayout p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditLayout p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
