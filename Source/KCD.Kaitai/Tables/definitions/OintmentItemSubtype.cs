...
{
    public partial class OintmentItemSubtype : KaitaiStruct
    {
        public static OintmentItemSubtype FromFile(string fileName)
        {
            return new OintmentItemSubtype(new KaitaiStream(fileName));
        }

        public OintmentItemSubtype(KaitaiStream p__io, KaitaiStruct p__parent = null, OintmentItemSubtype p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, OintmentItemSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private OintmentItemSubtype m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public OintmentItemSubtype M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, OintmentItemSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, OintmentItemSubtype p__parent = null, OintmentItemSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _ointmentItemSubtypeId = m_io.ReadS4le();
                _ointmentItemSubtypeName = m_io.ReadS4le();
            }
            private int _ointmentItemSubtypeId;
            private int _ointmentItemSubtypeName;
            private OintmentItemSubtype m_root;
            private OintmentItemSubtype m_parent;
            public int OintmentItemSubtypeId { get { return _ointmentItemSubtypeId; } }
            public int OintmentItemSubtypeName { get { return _ointmentItemSubtypeName; } }
            public OintmentItemSubtype M_Root { get { return m_root; } }
            public OintmentItemSubtype M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, OintmentItemSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, OintmentItemSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, OintmentItemSubtype p__parent = null, OintmentItemSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, OintmentItemSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, OintmentItemSubtype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
