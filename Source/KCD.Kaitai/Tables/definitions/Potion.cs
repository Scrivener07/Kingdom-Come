...
{
    public partial class Potion : KaitaiStruct
    {
        public static Potion FromFile(string fileName)
        {
            return new Potion(new KaitaiStream(fileName));
        }

        public Potion(KaitaiStream p__io, KaitaiStruct p__parent = null, Potion p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, Potion.Row p__parent = null, Potion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private Potion m_root;
            private Potion.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public Potion M_Root { get { return m_root; } }
            public Potion.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, Potion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, Potion p__parent = null, Potion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _weaponBuffId = new Uuid(m_io, this, m_root);
            }
            private Uuid _itemId;
            private Uuid _weaponBuffId;
            private Potion m_root;
            private Potion m_parent;
            public Uuid ItemId { get { return _itemId; } }
            public Uuid WeaponBuffId { get { return _weaponBuffId; } }
            public Potion M_Root { get { return m_root; } }
            public Potion M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, Potion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, Potion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, Potion p__parent = null, Potion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, Potion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, Potion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
