...
{
    public partial class ItemManipulationType : KaitaiStruct
    {
        public static ItemManipulationType FromFile(string fileName)
        {
            return new ItemManipulationType(new KaitaiStream(fileName));
        }

        public ItemManipulationType(KaitaiStream p__io, KaitaiStruct p__parent = null, ItemManipulationType p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, ItemManipulationType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private ItemManipulationType m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public ItemManipulationType M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, ItemManipulationType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, ItemManipulationType p__parent = null, ItemManipulationType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _id = m_io.ReadS4le();
                _tag = m_io.ReadS4le();
                _allowRun = m_io.ReadS1();
                _allowSprint = m_io.ReadS1();
                _sharpeningAnim = m_io.ReadS4le();
            }
            private int _id;
            private int _tag;
            private sbyte _allowRun;
            private sbyte _allowSprint;
            private int _sharpeningAnim;
            private ItemManipulationType m_root;
            private ItemManipulationType m_parent;
            public int Id { get { return _id; } }
            public int Tag { get { return _tag; } }
            public sbyte AllowRun { get { return _allowRun; } }
            public sbyte AllowSprint { get { return _allowSprint; } }
            public int SharpeningAnim { get { return _sharpeningAnim; } }
            public ItemManipulationType M_Root { get { return m_root; } }
            public ItemManipulationType M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, ItemManipulationType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, ItemManipulationType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, ItemManipulationType p__parent = null, ItemManipulationType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, ItemManipulationType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, ItemManipulationType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
