...
namespace KCD.Kaitai.Tables
{
    public partial class Location : KaitaiStruct
    {
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, Location.Row p__parent = null, Location p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, Location p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                _associatedCodexPerkId = new Uuid(m_io, this, m_root);
                _associatedPoiTypeId = new Uuid(m_io, this, m_root);
            }
            ...
            private Uuid _associatedCodexPerkId;
            private Uuid _associatedPoiTypeId;
            private Location m_root;
            ...
            public Uuid AssociatedCodexPerkId { get { return _associatedCodexPerkId; } }
            public Uuid AssociatedPoiTypeId { get { return _associatedPoiTypeId; } }
            public Location M_Root { get { return m_root; } }
        ...
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, Location p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, Location p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, Location p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, Location p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
