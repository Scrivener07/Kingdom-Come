...
{
    public partial class RandomEventOption : KaitaiStruct
    {
        public static RandomEventOption FromFile(string fileName)
        {
            return new RandomEventOption(new KaitaiStream(fileName));
        }

        public RandomEventOption(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventOption p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventOption p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private RandomEventOption m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public RandomEventOption M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventOption p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, RandomEventOption p__parent = null, RandomEventOption p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _randomEventOptionId = m_io.ReadS4le();
                _randomEventOptionSetId = m_io.ReadS4le();
                _randomEventSourceTypeId = m_io.ReadS4le();
                _uiCaption = m_io.ReadS4le();
                _conditionExpression = m_io.ReadS4le();
                _chanceExpression = m_io.ReadS4le();
                _successCmd = m_io.ReadS4le();
                _failCmd = m_io.ReadS4le();
                _successMsg = m_io.ReadS4le();
                _failMsg = m_io.ReadS4le();
            }
            private int _randomEventOptionId;
            private int _randomEventOptionSetId;
            private int _randomEventSourceTypeId;
            private int _uiCaption;
            private int _conditionExpression;
            private int _chanceExpression;
            private int _successCmd;
            private int _failCmd;
            private int _successMsg;
            private int _failMsg;
            private RandomEventOption m_root;
            private RandomEventOption m_parent;
            public int RandomEventOptionId { get { return _randomEventOptionId; } }
            public int RandomEventOptionSetId { get { return _randomEventOptionSetId; } }
            public int RandomEventSourceTypeId { get { return _randomEventSourceTypeId; } }
            public int UiCaption { get { return _uiCaption; } }
            public int ConditionExpression { get { return _conditionExpression; } }
            public int ChanceExpression { get { return _chanceExpression; } }
            public int SuccessCmd { get { return _successCmd; } }
            public int FailCmd { get { return _failCmd; } }
            public int SuccessMsg { get { return _successMsg; } }
            public int FailMsg { get { return _failMsg; } }
            public RandomEventOption M_Root { get { return m_root; } }
            public RandomEventOption M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventOption p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventOption p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, RandomEventOption p__parent = null, RandomEventOption p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventOption p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventOption p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
