...
{
    public partial class GoldDayoneStashDiff : KaitaiStruct
    {
        public static GoldDayoneStashDiff FromFile(string fileName)
        {
            return new GoldDayoneStashDiff(new KaitaiStream(fileName));
        }

        public GoldDayoneStashDiff(KaitaiStream p__io, KaitaiStruct p__parent = null, GoldDayoneStashDiff p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, GoldDayoneStashDiff.Row p__parent = null, GoldDayoneStashDiff p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private GoldDayoneStashDiff m_root;
            private GoldDayoneStashDiff.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public GoldDayoneStashDiff M_Root { get { return m_root; } }
            public GoldDayoneStashDiff.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, GoldDayoneStashDiff p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, GoldDayoneStashDiff p__parent = null, GoldDayoneStashDiff p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private int _amount;
            private GoldDayoneStashDiff m_root;
            private GoldDayoneStashDiff m_parent;
            public Uuid ItemGuid { get { return _itemGuid; } }
            public int Amount { get { return _amount; } }
            public GoldDayoneStashDiff M_Root { get { return m_root; } }
            public GoldDayoneStashDiff M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, GoldDayoneStashDiff p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, GoldDayoneStashDiff p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, GoldDayoneStashDiff p__parent = null, GoldDayoneStashDiff p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, GoldDayoneStashDiff p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, GoldDayoneStashDiff p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
