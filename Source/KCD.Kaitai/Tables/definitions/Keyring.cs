...
{
    public partial class Keyring : KaitaiStruct
    {
        public static Keyring FromFile(string fileName)
        {
            return new Keyring(new KaitaiStream(fileName));
        }

        public Keyring(KaitaiStream p__io, KaitaiStruct p__parent = null, Keyring p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, Keyring.Row p__parent = null, Keyring p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private Keyring m_root;
            private Keyring.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public Keyring M_Root { get { return m_root; } }
            public Keyring.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, Keyring p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, Keyring p__parent = null, Keyring p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _keyringTypeId = m_io.ReadS4le();
            }
            private Uuid _itemId;
            private int _keyringTypeId;
            private Keyring m_root;
            private Keyring m_parent;
            public Uuid ItemId { get { return _itemId; } }
            public int KeyringTypeId { get { return _keyringTypeId; } }
            public Keyring M_Root { get { return m_root; } }
            public Keyring M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, Keyring p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, Keyring p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, Keyring p__parent = null, Keyring p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, Keyring p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, Keyring p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
