...
{
    public partial class Armor2clothingPreset : KaitaiStruct
    {
        public static Armor2clothingPreset FromFile(string fileName)
        {
            return new Armor2clothingPreset(new KaitaiStream(fileName));
        }

        public Armor2clothingPreset(KaitaiStream p__io, KaitaiStruct p__parent = null, Armor2clothingPreset p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, Armor2clothingPreset.Row p__parent = null, Armor2clothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private Armor2clothingPreset m_root;
            private Armor2clothingPreset.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public Armor2clothingPreset M_Root { get { return m_root; } }
            public Armor2clothingPreset.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, Armor2clothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, Armor2clothingPreset p__parent = null, Armor2clothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _armorId = new Uuid(m_io, this, m_root);
            }
            private Uuid _clothingPresetId;
            private Uuid _armorId;
            private Armor2clothingPreset m_root;
            private Armor2clothingPreset m_parent;
            public Uuid ClothingPresetId { get { return _clothingPresetId; } }
            public Uuid ArmorId { get { return _armorId; } }
            public Armor2clothingPreset M_Root { get { return m_root; } }
            public Armor2clothingPreset M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, Armor2clothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, Armor2clothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, Armor2clothingPreset p__parent = null, Armor2clothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, Armor2clothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, Armor2clothingPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
