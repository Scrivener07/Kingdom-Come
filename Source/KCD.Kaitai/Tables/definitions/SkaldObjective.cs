...
{
    public partial class SkaldObjective : KaitaiStruct
    {
        public static SkaldObjective FromFile(string fileName)
        {
            return new SkaldObjective(new KaitaiStream(fileName));
        }

        public SkaldObjective(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldObjective p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, SkaldObjective.Row p__parent = null, SkaldObjective p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SkaldObjective m_root;
            private SkaldObjective.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public SkaldObjective M_Root { get { return m_root; } }
            public SkaldObjective.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldObjective p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SkaldObjective p__parent = null, SkaldObjective p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _objectiveTypeId = m_io.ReadS4le();
                _isSave = m_io.ReadS4le();
                _localmapLocationId = new Uuid(m_io, this, m_root);
            }
            ...
            private int _isSave;
            private Uuid _localmapLocationId;
            private SkaldObjective m_root;
            private SkaldObjective m_parent;
            ...
            public int ObjectiveTypeId { get { return _objectiveTypeId; } }
            public int IsSave { get { return _isSave; } }
            public Uuid LocalmapLocationId { get { return _localmapLocationId; } }
            public SkaldObjective M_Root { get { return m_root; } }
            public SkaldObjective M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldObjective p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldObjective p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SkaldObjective p__parent = null, SkaldObjective p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldObjective p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldObjective p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
