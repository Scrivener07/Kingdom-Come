...
{
    public partial class SoBehaviourState : KaitaiStruct
    {
        public static SoBehaviourState FromFile(string fileName)
        {
            return new SoBehaviourState(new KaitaiStream(fileName));
        }

        public SoBehaviourState(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourState p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourState p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SoBehaviourState m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public SoBehaviourState M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourState p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SoBehaviourState p__parent = null, SoBehaviourState p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _soBehaviourStateId = m_io.ReadS4le();
                _soBehaviourStateName = m_io.ReadS4le();
            }
            private int _soBehaviourStateId;
            private int _soBehaviourStateName;
            private SoBehaviourState m_root;
            private SoBehaviourState m_parent;
            public int SoBehaviourStateId { get { return _soBehaviourStateId; } }
            public int SoBehaviourStateName { get { return _soBehaviourStateName; } }
            public SoBehaviourState M_Root { get { return m_root; } }
            public SoBehaviourState M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourState p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourState p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SoBehaviourState p__parent = null, SoBehaviourState p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourState p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourState p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
