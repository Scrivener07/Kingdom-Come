...
{
    public partial class AlchemyMaterialType : KaitaiStruct
    {
        public static AlchemyMaterialType FromFile(string fileName)
        {
            return new AlchemyMaterialType(new KaitaiStream(fileName));
        }

        public AlchemyMaterialType(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyMaterialType p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyMaterialType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AlchemyMaterialType m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public AlchemyMaterialType M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyMaterialType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, AlchemyMaterialType p__parent = null, AlchemyMaterialType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _alchemyMaterialTypeName = m_io.ReadS4le();
            }
            private int _alchemyMaterialTypeId;
            private int _alchemyMaterialTypeName;
            private AlchemyMaterialType m_root;
            private AlchemyMaterialType m_parent;
            public int AlchemyMaterialTypeId { get { return _alchemyMaterialTypeId; } }
            public int AlchemyMaterialTypeName { get { return _alchemyMaterialTypeName; } }
            public AlchemyMaterialType M_Root { get { return m_root; } }
            public AlchemyMaterialType M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyMaterialType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyMaterialType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, AlchemyMaterialType p__parent = null, AlchemyMaterialType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyMaterialType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyMaterialType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
