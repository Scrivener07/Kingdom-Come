...
{
    public partial class PerkScript : KaitaiStruct
    {
        public static PerkScript FromFile(string fileName)
        {
            return new PerkScript(new KaitaiStream(fileName));
        }

        public PerkScript(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkScript p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, PerkScript.Row p__parent = null, PerkScript p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private PerkScript m_root;
            private PerkScript.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public PerkScript M_Root { get { return m_root; } }
            public PerkScript.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkScript p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, PerkScript p__parent = null, PerkScript p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _perkEditorName = m_io.ReadS4le();
            }
            private Uuid _perkId;
            private int _perkEditorName;
            private PerkScript m_root;
            private PerkScript m_parent;
            public Uuid PerkId { get { return _perkId; } }
            public int PerkEditorName { get { return _perkEditorName; } }
            public PerkScript M_Root { get { return m_root; } }
            public PerkScript M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkScript p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkScript p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, PerkScript p__parent = null, PerkScript p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkScript p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkScript p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
