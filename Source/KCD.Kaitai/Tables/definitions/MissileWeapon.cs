...
{
    public partial class MissileWeapon : KaitaiStruct
    {
        public static MissileWeapon FromFile(string fileName)
        {
            return new MissileWeapon(new KaitaiStream(fileName));
        }

        public MissileWeapon(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeapon p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, MissileWeapon.Row p__parent = null, MissileWeapon p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private MissileWeapon m_root;
            private MissileWeapon.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public MissileWeapon M_Root { get { return m_root; } }
            public MissileWeapon.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeapon p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, MissileWeapon p__parent = null, MissileWeapon p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _weaponSoundSwitch = m_io.ReadS4le();
            }
            private Uuid _itemId;
            private float _power;
            private int _weaponSoundSwitch;
            private MissileWeapon m_root;
            private MissileWeapon m_parent;
            public Uuid ItemId { get { return _itemId; } }
            public float Power { get { return _power; } }
            public int WeaponSoundSwitch { get { return _weaponSoundSwitch; } }
            public MissileWeapon M_Root { get { return m_root; } }
            public MissileWeapon M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeapon p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeapon p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, MissileWeapon p__parent = null, MissileWeapon p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeapon p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeapon p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
