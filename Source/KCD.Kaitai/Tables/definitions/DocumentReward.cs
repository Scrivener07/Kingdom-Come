...
{
    public partial class DocumentReward : KaitaiStruct
    {
        public static DocumentReward FromFile(string fileName)
        {
            return new DocumentReward(new KaitaiStream(fileName));
        }

        public DocumentReward(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentReward p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, DocumentReward.Row p__parent = null, DocumentReward p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private DocumentReward m_root;
            private DocumentReward.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public DocumentReward M_Root { get { return m_root; } }
            public DocumentReward.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentReward p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, DocumentReward p__parent = null, DocumentReward p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private int _script;
            private DocumentReward m_root;
            private DocumentReward m_parent;
            public Uuid ItemId { get { return _itemId; } }
            public int Script { get { return _script; } }
            public DocumentReward M_Root { get { return m_root; } }
            public DocumentReward M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentReward p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentReward p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, DocumentReward p__parent = null, DocumentReward p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentReward p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentReward p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
