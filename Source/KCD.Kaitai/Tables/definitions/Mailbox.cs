...
{
    public partial class Mailbox : KaitaiStruct
    {
        public static Mailbox FromFile(string fileName)
        {
            return new Mailbox(new KaitaiStream(fileName));
        }

        public Mailbox(KaitaiStream p__io, KaitaiStruct p__parent = null, Mailbox p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, Mailbox.Row p__parent = null, Mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private Mailbox m_root;
            private Mailbox.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public Mailbox M_Root { get { return m_root; } }
            public Mailbox.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, Mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, Mailbox p__parent = null, Mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _mailboxName = m_io.ReadS4le();
                _onAccept = m_io.ReadS4le();
                _messageLimit = m_io.ReadS4le();
            }
            private Uuid _mailboxId;
            private int _mailboxName;
            private int _onAccept;
            private int _messageLimit;
            private Mailbox m_root;
            private Mailbox m_parent;
            public Uuid MailboxId { get { return _mailboxId; } }
            public int MailboxName { get { return _mailboxName; } }
            public int OnAccept { get { return _onAccept; } }
            public int MessageLimit { get { return _messageLimit; } }
            public Mailbox M_Root { get { return m_root; } }
            public Mailbox M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, Mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, Mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, Mailbox p__parent = null, Mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, Mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, Mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
