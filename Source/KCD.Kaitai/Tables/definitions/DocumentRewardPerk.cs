...
{
    public partial class DocumentRewardPerk : KaitaiStruct
    {
        public static DocumentRewardPerk FromFile(string fileName)
        {
            return new DocumentRewardPerk(new KaitaiStream(fileName));
        }

        public DocumentRewardPerk(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentRewardPerk p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, DocumentRewardPerk.Row p__parent = null, DocumentRewardPerk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private DocumentRewardPerk m_root;
            private DocumentRewardPerk.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public DocumentRewardPerk M_Root { get { return m_root; } }
            public DocumentRewardPerk.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentRewardPerk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, DocumentRewardPerk p__parent = null, DocumentRewardPerk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _progressThatGivesThePerk = m_io.ReadF4le();
            }
            private Uuid _itemId;
            private Uuid _perkId;
            private float _progressThatGivesThePerk;
            private DocumentRewardPerk m_root;
            private DocumentRewardPerk m_parent;
            public Uuid ItemId { get { return _itemId; } }
            public Uuid PerkId { get { return _perkId; } }
            public float ProgressThatGivesThePerk { get { return _progressThatGivesThePerk; } }
            public DocumentRewardPerk M_Root { get { return m_root; } }
            public DocumentRewardPerk M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentRewardPerk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentRewardPerk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, DocumentRewardPerk p__parent = null, DocumentRewardPerk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentRewardPerk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentRewardPerk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
