...
{
    public partial class CfBackerIngame : KaitaiStruct
    {
        public static CfBackerIngame FromFile(string fileName)
        {
            return new CfBackerIngame(new KaitaiStream(fileName));
        }

        public CfBackerIngame(KaitaiStream p__io, KaitaiStruct p__parent = null, CfBackerIngame p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CfBackerIngame p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CfBackerIngame m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CfBackerIngame M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CfBackerIngame p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CfBackerIngame p__parent = null, CfBackerIngame p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _cfBackerId = m_io.ReadS4le();
                _cfBackerIngameName = m_io.ReadS4le();
                _calvaryCrossId = m_io.ReadS4le();
            }
            private int _cfBackerId;
            private int _cfBackerIngameName;
            private int _calvaryCrossId;
            private CfBackerIngame m_root;
            private CfBackerIngame m_parent;
            public int CfBackerId { get { return _cfBackerId; } }
            public int CfBackerIngameName { get { return _cfBackerIngameName; } }
            public int CalvaryCrossId { get { return _calvaryCrossId; } }
            public CfBackerIngame M_Root { get { return m_root; } }
            public CfBackerIngame M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CfBackerIngame p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, CfBackerIngame p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CfBackerIngame p__parent = null, CfBackerIngame p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CfBackerIngame p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CfBackerIngame p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
