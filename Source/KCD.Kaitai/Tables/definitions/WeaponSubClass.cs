...
{
    public partial class WeaponSubClass : KaitaiStruct
    {
        public static WeaponSubClass FromFile(string fileName)
        {
            return new WeaponSubClass(new KaitaiStream(fileName));
        }

        public WeaponSubClass(KaitaiStream p__io, KaitaiStruct p__parent = null, WeaponSubClass p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, WeaponSubClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private WeaponSubClass m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public WeaponSubClass M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, WeaponSubClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, WeaponSubClass p__parent = null, WeaponSubClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _weaponSubClassName = m_io.ReadS4le();
            }
            private int _weaponSubClassId;
            private int _weaponSubClassName;
            private WeaponSubClass m_root;
            private WeaponSubClass m_parent;
            public int WeaponSubClassId { get { return _weaponSubClassId; } }
            public int WeaponSubClassName { get { return _weaponSubClassName; } }
            public WeaponSubClass M_Root { get { return m_root; } }
            public WeaponSubClass M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, WeaponSubClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, WeaponSubClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, WeaponSubClass p__parent = null, WeaponSubClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, WeaponSubClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, WeaponSubClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
