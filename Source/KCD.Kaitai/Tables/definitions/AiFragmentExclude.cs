...
{
    public partial class AiFragmentExclude : KaitaiStruct
    {
        public static AiFragmentExclude FromFile(string fileName)
        {
            return new AiFragmentExclude(new KaitaiStream(fileName));
        }

        public AiFragmentExclude(KaitaiStream p__io, KaitaiStruct p__parent = null, AiFragmentExclude p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, AiFragmentExclude p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AiFragmentExclude m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public AiFragmentExclude M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, AiFragmentExclude p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, AiFragmentExclude p__parent = null, AiFragmentExclude p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _aiFragmentExcludeId = m_io.ReadS4le();
                _aiFragmentExcludePrefix = m_io.ReadS4le();
            }
            private int _aiFragmentExcludeId;
            private int _aiFragmentExcludePrefix;
            private AiFragmentExclude m_root;
            private AiFragmentExclude m_parent;
            public int AiFragmentExcludeId { get { return _aiFragmentExcludeId; } }
            public int AiFragmentExcludePrefix { get { return _aiFragmentExcludePrefix; } }
            public AiFragmentExclude M_Root { get { return m_root; } }
            public AiFragmentExclude M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, AiFragmentExclude p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, AiFragmentExclude p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, AiFragmentExclude p__parent = null, AiFragmentExclude p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, AiFragmentExclude p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, AiFragmentExclude p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
