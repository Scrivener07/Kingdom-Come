...
{
    public partial class Shopkeeper : KaitaiStruct
    {
        public static Shopkeeper FromFile(string fileName)
        {
            return new Shopkeeper(new KaitaiStream(fileName));
        }

        public Shopkeeper(KaitaiStream p__io, KaitaiStruct p__parent = null, Shopkeeper p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, Shopkeeper.Row p__parent = null, Shopkeeper p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private Shopkeeper m_root;
            private Shopkeeper.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public Shopkeeper M_Root { get { return m_root; } }
            public Shopkeeper.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, Shopkeeper p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, Shopkeeper p__parent = null, Shopkeeper p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _keeperId = new Uuid(m_io, this, m_root);
                _shopId = m_io.ReadS4le();
            }
            private int _computerName;
            private int _timestamp;
            private int _levelName;
            private Uuid _keeperId;
            private int _shopId;
            private Shopkeeper m_root;
            private Shopkeeper m_parent;
            ...
            public Uuid KeeperId { get { return _keeperId; } }
            public int ShopId { get { return _shopId; } }
            public Shopkeeper M_Root { get { return m_root; } }
            public Shopkeeper M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, Shopkeeper p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, Shopkeeper p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, Shopkeeper p__parent = null, Shopkeeper p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, Shopkeeper p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, Shopkeeper p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
