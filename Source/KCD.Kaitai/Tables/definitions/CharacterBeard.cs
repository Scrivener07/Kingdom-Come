...
{
    public partial class CharacterBeard : KaitaiStruct
    {
        public static CharacterBeard FromFile(string fileName)
        {
            return new CharacterBeard(new KaitaiStream(fileName));
        }

        public CharacterBeard(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterBeard p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, CharacterBeard.Row p__parent = null, CharacterBeard p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CharacterBeard m_root;
            private CharacterBeard.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CharacterBeard M_Root { get { return m_root; } }
            public CharacterBeard.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterBeard p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CharacterBeard p__parent = null, CharacterBeard p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _characterBeardName = m_io.ReadS4le();
                ...
                _characterBeardArchetypeId = m_io.ReadS4le();
            }
            private int _computerName;
            private int _timestamp;
            private Uuid _characterBeardId;
            private int _characterBeardName;
            private int _model;
            ...
            private int _raceId;
            private int _characterBeardArchetypeId;
            private CharacterBeard m_root;
            private CharacterBeard m_parent;
            ...
            public int CharacterBeardName { get { return _characterBeardName; } }
            ...
            public int CharacterBeardArchetypeId { get { return _characterBeardArchetypeId; } }
            public CharacterBeard M_Root { get { return m_root; } }
            public CharacterBeard M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterBeard p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterBeard p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CharacterBeard p__parent = null, CharacterBeard p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterBeard p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterBeard p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
