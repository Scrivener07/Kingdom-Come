...
{
    public partial class DocumentContentImages : KaitaiStruct
    {
        public static DocumentContentImages FromFile(string fileName)
        {
            return new DocumentContentImages(new KaitaiStream(fileName));
        }

        public DocumentContentImages(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentContentImages p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentContentImages p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private DocumentContentImages m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public DocumentContentImages M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentContentImages p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, DocumentContentImages p__parent = null, DocumentContentImages p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _page = m_io.ReadS4le();
                _image = m_io.ReadS4le();
            }
            private int _textId;
            private int _page;
            private int _image;
            private DocumentContentImages m_root;
            private DocumentContentImages m_parent;
            public int TextId { get { return _textId; } }
            public int Page { get { return _page; } }
            public int Image { get { return _image; } }
            public DocumentContentImages M_Root { get { return m_root; } }
            public DocumentContentImages M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentContentImages p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentContentImages p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, DocumentContentImages p__parent = null, DocumentContentImages p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentContentImages p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentContentImages p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
