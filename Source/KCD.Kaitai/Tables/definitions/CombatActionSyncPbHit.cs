...
{
    public partial class CombatActionSyncPbHit : KaitaiStruct
    {
        public static CombatActionSyncPbHit FromFile(string fileName)
        {
            return new CombatActionSyncPbHit(new KaitaiStream(fileName));
        }

        public CombatActionSyncPbHit(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionSyncPbHit p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionSyncPbHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionSyncPbHit m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CombatActionSyncPbHit M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionSyncPbHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CombatActionSyncPbHit p__parent = null, CombatActionSyncPbHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _continueAttack = m_io.ReadS1();
                _syncHit = m_io.ReadF4le();
            }
            ...
            private int _mnTags;
            private sbyte _continueAttack;
            private float _syncHit;
            private CombatActionSyncPbHit m_root;
            private CombatActionSyncPbHit m_parent;
            ...
            public sbyte ContinueAttack { get { return _continueAttack; } }
            public float SyncHit { get { return _syncHit; } }
            public CombatActionSyncPbHit M_Root { get { return m_root; } }
            public CombatActionSyncPbHit M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionSyncPbHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, CombatActionSyncPbHit.Row p__parent = null, CombatActionSyncPbHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionSyncPbHit m_root;
            private CombatActionSyncPbHit.Row m_parent;
            public byte[] QuattType { get { return _quattType; } }
            public CombatActionSyncPbHit M_Root { get { return m_root; } }
            public CombatActionSyncPbHit.Row M_Parent { get { return m_parent; } }
        }
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CombatActionSyncPbHit p__parent = null, CombatActionSyncPbHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionSyncPbHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionSyncPbHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
