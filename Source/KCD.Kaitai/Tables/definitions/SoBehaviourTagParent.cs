...
{
    public partial class SoBehaviourTagParent : KaitaiStruct
    {
        public static SoBehaviourTagParent FromFile(string fileName)
        {
            return new SoBehaviourTagParent(new KaitaiStream(fileName));
        }

        public SoBehaviourTagParent(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourTagParent p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, SoBehaviourTagParent.Row p__parent = null, SoBehaviourTagParent p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SoBehaviourTagParent m_root;
            private SoBehaviourTagParent.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public SoBehaviourTagParent M_Root { get { return m_root; } }
            public SoBehaviourTagParent.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourTagParent p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SoBehaviourTagParent p__parent = null, SoBehaviourTagParent p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SoBehaviourTagParent m_root;
            private SoBehaviourTagParent m_parent;
            ...
            public SoBehaviourTagParent M_Root { get { return m_root; } }
            public SoBehaviourTagParent M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourTagParent p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourTagParent p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SoBehaviourTagParent p__parent = null, SoBehaviourTagParent p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourTagParent p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourTagParent p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
