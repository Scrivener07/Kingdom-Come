...
{
    public partial class QuestibleItem : KaitaiStruct
    {
        public static QuestibleItem FromFile(string fileName)
        {
            return new QuestibleItem(new KaitaiStream(fileName));
        }

        public QuestibleItem(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestibleItem p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, QuestibleItem.Row p__parent = null, QuestibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private QuestibleItem m_root;
            private QuestibleItem.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public QuestibleItem M_Root { get { return m_root; } }
            public QuestibleItem.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, QuestibleItem p__parent = null, QuestibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _isQuest = m_io.ReadS1();
            }
            private Uuid _itemId;
            private sbyte _isQuest;
            private QuestibleItem m_root;
            private QuestibleItem m_parent;
            public Uuid ItemId { get { return _itemId; } }
            public sbyte IsQuest { get { return _isQuest; } }
            public QuestibleItem M_Root { get { return m_root; } }
            public QuestibleItem M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, QuestibleItem p__parent = null, QuestibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
