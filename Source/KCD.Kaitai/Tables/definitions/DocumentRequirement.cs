...
{
    public partial class DocumentRequirement : KaitaiStruct
    {
        public static DocumentRequirement FromFile(string fileName)
        {
            return new DocumentRequirement(new KaitaiStream(fileName));
        }

        public DocumentRequirement(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentRequirement p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, DocumentRequirement.Row p__parent = null, DocumentRequirement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private DocumentRequirement m_root;
            private DocumentRequirement.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public DocumentRequirement M_Root { get { return m_root; } }
            public DocumentRequirement.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentRequirement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, DocumentRequirement p__parent = null, DocumentRequirement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private int _script;
            private DocumentRequirement m_root;
            private DocumentRequirement m_parent;
            public Uuid ItemId { get { return _itemId; } }
            public int Script { get { return _script; } }
            public DocumentRequirement M_Root { get { return m_root; } }
            public DocumentRequirement M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentRequirement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentRequirement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, DocumentRequirement p__parent = null, DocumentRequirement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentRequirement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, DocumentRequirement p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
