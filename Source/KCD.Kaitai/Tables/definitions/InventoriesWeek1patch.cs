...
{
    public partial class InventoriesWeek1patch : KaitaiStruct
    {
        public static InventoriesWeek1patch FromFile(string fileName)
        {
            return new InventoriesWeek1patch(new KaitaiStream(fileName));
        }

        public InventoriesWeek1patch(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoriesWeek1patch p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, InventoriesWeek1patch.Row p__parent = null, InventoriesWeek1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private InventoriesWeek1patch m_root;
            private InventoriesWeek1patch.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public InventoriesWeek1patch M_Root { get { return m_root; } }
            public InventoriesWeek1patch.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoriesWeek1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, InventoriesWeek1patch p__parent = null, InventoriesWeek1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _itemGuid = new Uuid(m_io, this, m_root);
                _amount = m_io.ReadS4le();
            }
            private Uuid _itemGuid;
            private int _amount;
            private InventoriesWeek1patch m_root;
            private InventoriesWeek1patch m_parent;
            public Uuid ItemGuid { get { return _itemGuid; } }
            public int Amount { get { return _amount; } }
            public InventoriesWeek1patch M_Root { get { return m_root; } }
            public InventoriesWeek1patch M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoriesWeek1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoriesWeek1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, InventoriesWeek1patch p__parent = null, InventoriesWeek1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoriesWeek1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, InventoriesWeek1patch p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
