...
{
    public partial class DivisibleItem : KaitaiStruct
    {
        public static DivisibleItem FromFile(string fileName)
        {
            return new DivisibleItem(new KaitaiStream(fileName));
        }

        public DivisibleItem(KaitaiStream p__io, KaitaiStruct p__parent = null, DivisibleItem p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, DivisibleItem.Row p__parent = null, DivisibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private DivisibleItem m_root;
            private DivisibleItem.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public DivisibleItem M_Root { get { return m_root; } }
            public DivisibleItem.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, DivisibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, DivisibleItem p__parent = null, DivisibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _isDivisible = m_io.ReadS1();
                _containerModel = m_io.ReadS4le();
                _containerMaterial = m_io.ReadS4le();
            }
            private Uuid _itemId;
            private sbyte _isDivisible;
            private int _containerModel;
            private int _containerMaterial;
            private DivisibleItem m_root;
            private DivisibleItem m_parent;
            public Uuid ItemId { get { return _itemId; } }
            public sbyte IsDivisible { get { return _isDivisible; } }
            public int ContainerModel { get { return _containerModel; } }
            public int ContainerMaterial { get { return _containerMaterial; } }
            public DivisibleItem M_Root { get { return m_root; } }
            public DivisibleItem M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, DivisibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, DivisibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, DivisibleItem p__parent = null, DivisibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, DivisibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, DivisibleItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
