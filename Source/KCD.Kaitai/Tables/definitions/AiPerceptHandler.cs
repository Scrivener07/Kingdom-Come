...
{
    public partial class AiPerceptHandler : KaitaiStruct
    {
        public static AiPerceptHandler FromFile(string fileName)
        {
            return new AiPerceptHandler(new KaitaiStream(fileName));
        }

        public AiPerceptHandler(KaitaiStream p__io, KaitaiStruct p__parent = null, AiPerceptHandler p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, AiPerceptHandler.Row p__parent = null, AiPerceptHandler p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AiPerceptHandler m_root;
            private AiPerceptHandler.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public AiPerceptHandler M_Root { get { return m_root; } }
            public AiPerceptHandler.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, AiPerceptHandler p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, AiPerceptHandler p__parent = null, AiPerceptHandler p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _aiPerceptHandlerName = m_io.ReadS4le();
                _aiPerceptHandlerType = m_io.ReadS4le();
                _data = m_io.ReadS4le();
            }
            private Uuid _aiPerceptHandlerId;
            private int _aiPerceptHandlerName;
            private int _aiPerceptHandlerType;
            private int _data;
            private AiPerceptHandler m_root;
            private AiPerceptHandler m_parent;
            public Uuid AiPerceptHandlerId { get { return _aiPerceptHandlerId; } }
            public int AiPerceptHandlerName { get { return _aiPerceptHandlerName; } }
            public int AiPerceptHandlerType { get { return _aiPerceptHandlerType; } }
            public int Data { get { return _data; } }
            public AiPerceptHandler M_Root { get { return m_root; } }
            public AiPerceptHandler M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, AiPerceptHandler p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, AiPerceptHandler p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, AiPerceptHandler p__parent = null, AiPerceptHandler p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, AiPerceptHandler p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, AiPerceptHandler p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
