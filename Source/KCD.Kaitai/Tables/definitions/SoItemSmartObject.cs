...
{
    public partial class SoItemSmartObject : KaitaiStruct
    {
        public static SoItemSmartObject FromFile(string fileName)
        {
            return new SoItemSmartObject(new KaitaiStream(fileName));
        }

        public SoItemSmartObject(KaitaiStream p__io, KaitaiStruct p__parent = null, SoItemSmartObject p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, SoItemSmartObject.Row p__parent = null, SoItemSmartObject p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SoItemSmartObject m_root;
            private SoItemSmartObject.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public SoItemSmartObject M_Root { get { return m_root; } }
            public SoItemSmartObject.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, SoItemSmartObject p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SoItemSmartObject p__parent = null, SoItemSmartObject p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _itemClassId = new Uuid(m_io, this, m_root);
                _soSmartObjectId = new Uuid(m_io, this, m_root);
                _helperSetName = m_io.ReadS4le();
            }
            private Uuid _itemClassId;
            private Uuid _soSmartObjectId;
            private int _helperSetName;
            private SoItemSmartObject m_root;
            private SoItemSmartObject m_parent;
            public Uuid ItemClassId { get { return _itemClassId; } }
            public Uuid SoSmartObjectId { get { return _soSmartObjectId; } }
            public int HelperSetName { get { return _helperSetName; } }
            public SoItemSmartObject M_Root { get { return m_root; } }
            public SoItemSmartObject M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SoItemSmartObject p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SoItemSmartObject p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SoItemSmartObject p__parent = null, SoItemSmartObject p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SoItemSmartObject p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SoItemSmartObject p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
