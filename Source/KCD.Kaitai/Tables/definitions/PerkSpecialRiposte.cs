...
{
    public partial class PerkSpecialRiposte : KaitaiStruct
    {
        public static PerkSpecialRiposte FromFile(string fileName)
        {
            return new PerkSpecialRiposte(new KaitaiStream(fileName));
        }

        public PerkSpecialRiposte(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkSpecialRiposte p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, PerkSpecialRiposte.Row p__parent = null, PerkSpecialRiposte p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private PerkSpecialRiposte m_root;
            private PerkSpecialRiposte.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public PerkSpecialRiposte M_Root { get { return m_root; } }
            public PerkSpecialRiposte.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkSpecialRiposte p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, PerkSpecialRiposte p__parent = null, PerkSpecialRiposte p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _specialRiposteId = m_io.ReadS4le();
            }
            private Uuid _perkId;
            private int _specialRiposteId;
            private PerkSpecialRiposte m_root;
            private PerkSpecialRiposte m_parent;
            public Uuid PerkId { get { return _perkId; } }
            public int SpecialRiposteId { get { return _specialRiposteId; } }
            public PerkSpecialRiposte M_Root { get { return m_root; } }
            public PerkSpecialRiposte M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkSpecialRiposte p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkSpecialRiposte p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, PerkSpecialRiposte p__parent = null, PerkSpecialRiposte p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkSpecialRiposte p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkSpecialRiposte p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
