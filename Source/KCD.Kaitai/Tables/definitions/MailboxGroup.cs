...
{
    public partial class MailboxGroup : KaitaiStruct
    {
        public static MailboxGroup FromFile(string fileName)
        {
            return new MailboxGroup(new KaitaiStream(fileName));
        }

        public MailboxGroup(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxGroup p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, MailboxGroup.Row p__parent = null, MailboxGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private MailboxGroup m_root;
            private MailboxGroup.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public MailboxGroup M_Root { get { return m_root; } }
            public MailboxGroup.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, MailboxGroup p__parent = null, MailboxGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _mailboxGroupFileName = m_io.ReadS4le();
                _mailboxGroupTreeName = m_io.ReadS4le();
            }
            private Uuid _mailboxGroupId;
            private int _mailboxGroupFileName;
            private int _mailboxGroupTreeName;
            private MailboxGroup m_root;
            private MailboxGroup m_parent;
            public Uuid MailboxGroupId { get { return _mailboxGroupId; } }
            public int MailboxGroupFileName { get { return _mailboxGroupFileName; } }
            public int MailboxGroupTreeName { get { return _mailboxGroupTreeName; } }
            public MailboxGroup M_Root { get { return m_root; } }
            public MailboxGroup M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, MailboxGroup p__parent = null, MailboxGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
