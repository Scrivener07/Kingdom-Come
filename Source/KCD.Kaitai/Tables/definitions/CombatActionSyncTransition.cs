...
{
    public partial class CombatActionSyncTransition : KaitaiStruct
    {
        public static CombatActionSyncTransition FromFile(string fileName)
        {
            return new CombatActionSyncTransition(new KaitaiStream(fileName));
        }

        public CombatActionSyncTransition(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionSyncTransition p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionSyncTransition p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionSyncTransition m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CombatActionSyncTransition M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionSyncTransition p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CombatActionSyncTransition p__parent = null, CombatActionSyncTransition p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionSyncTransition m_root;
            private CombatActionSyncTransition m_parent;
            ...
            public CombatActionSyncTransition M_Root { get { return m_root; } }
            public CombatActionSyncTransition M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionSyncTransition p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, CombatActionSyncTransition.Row p__parent = null, CombatActionSyncTransition p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionSyncTransition m_root;
            private CombatActionSyncTransition.Row m_parent;
            public byte[] QuattType { get { return _quattType; } }
            public CombatActionSyncTransition M_Root { get { return m_root; } }
            public CombatActionSyncTransition.Row M_Parent { get { return m_parent; } }
        }
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CombatActionSyncTransition p__parent = null, CombatActionSyncTransition p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionSyncTransition p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionSyncTransition p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
