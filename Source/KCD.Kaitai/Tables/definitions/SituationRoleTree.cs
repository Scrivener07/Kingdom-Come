...
{
    public partial class SituationRoleTree : KaitaiStruct
    {
        public static SituationRoleTree FromFile(string fileName)
        {
            return new SituationRoleTree(new KaitaiStream(fileName));
        }

        public SituationRoleTree(KaitaiStream p__io, KaitaiStruct p__parent = null, SituationRoleTree p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, SituationRoleTree.Row p__parent = null, SituationRoleTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SituationRoleTree m_root;
            private SituationRoleTree.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public SituationRoleTree M_Root { get { return m_root; } }
            public SituationRoleTree.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, SituationRoleTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SituationRoleTree p__parent = null, SituationRoleTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _situationRoleId = new Uuid(m_io, this, m_root);
                _situationVariantId = new Uuid(m_io, this, m_root);
                _treeFile = m_io.ReadS4le();
                _treeName = m_io.ReadS4le();
            }
            private Uuid _situationRoleId;
            private Uuid _situationVariantId;
            private int _treeFile;
            private int _treeName;
            private SituationRoleTree m_root;
            private SituationRoleTree m_parent;
            public Uuid SituationRoleId { get { return _situationRoleId; } }
            public Uuid SituationVariantId { get { return _situationVariantId; } }
            public int TreeFile { get { return _treeFile; } }
            public int TreeName { get { return _treeName; } }
            public SituationRoleTree M_Root { get { return m_root; } }
            public SituationRoleTree M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SituationRoleTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SituationRoleTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SituationRoleTree p__parent = null, SituationRoleTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SituationRoleTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SituationRoleTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
