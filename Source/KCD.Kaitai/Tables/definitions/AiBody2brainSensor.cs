...
{
    public partial class AiBody2brainSensor : KaitaiStruct
    {
        public static AiBody2brainSensor FromFile(string fileName)
        {
            return new AiBody2brainSensor(new KaitaiStream(fileName));
        }

        public AiBody2brainSensor(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody2brainSensor p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, AiBody2brainSensor.Row p__parent = null, AiBody2brainSensor p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AiBody2brainSensor m_root;
            private AiBody2brainSensor.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public AiBody2brainSensor M_Root { get { return m_root; } }
            public AiBody2brainSensor.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody2brainSensor p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, AiBody2brainSensor p__parent = null, AiBody2brainSensor p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _brainSensorId = new Uuid(m_io, this, m_root);
            }
            private Uuid _aiBodyId;
            private Uuid _brainSensorId;
            private AiBody2brainSensor m_root;
            private AiBody2brainSensor m_parent;
            public Uuid AiBodyId { get { return _aiBodyId; } }
            public Uuid BrainSensorId { get { return _brainSensorId; } }
            public AiBody2brainSensor M_Root { get { return m_root; } }
            public AiBody2brainSensor M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody2brainSensor p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody2brainSensor p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, AiBody2brainSensor p__parent = null, AiBody2brainSensor p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody2brainSensor p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody2brainSensor p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
