...
{
    public partial class SoulSlot2health : KaitaiStruct
    {
        public static SoulSlot2health FromFile(string fileName)
        {
            return new SoulSlot2health(new KaitaiStream(fileName));
        }

        public SoulSlot2health(KaitaiStream p__io, KaitaiStruct p__parent = null, SoulSlot2health p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, SoulSlot2health.Row p__parent = null, SoulSlot2health p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SoulSlot2health m_root;
            private SoulSlot2health.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public SoulSlot2health M_Root { get { return m_root; } }
            public SoulSlot2health.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, SoulSlot2health p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SoulSlot2health p__parent = null, SoulSlot2health p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SoulSlot2health p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SoulSlot2health p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SoulSlot2health p__parent = null, SoulSlot2health p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SoulSlot2health p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SoulSlot2health p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
