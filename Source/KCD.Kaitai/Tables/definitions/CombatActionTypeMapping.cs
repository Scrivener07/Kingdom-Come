...
{
    public partial class CombatActionTypeMapping : KaitaiStruct
    {
        public static CombatActionTypeMapping FromFile(string fileName)
        {
            return new CombatActionTypeMapping(new KaitaiStream(fileName));
        }

        public CombatActionTypeMapping(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionTypeMapping p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionTypeMapping m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CombatActionTypeMapping M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CombatActionTypeMapping p__parent = null, CombatActionTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _srcActionTypeId = m_io.ReadS4le();
                _dstActionTypeId = m_io.ReadS4le();
            }
            private int _srcActionTypeId;
            private int _dstActionTypeId;
            private CombatActionTypeMapping m_root;
            private CombatActionTypeMapping m_parent;
            public int SrcActionTypeId { get { return _srcActionTypeId; } }
            public int DstActionTypeId { get { return _dstActionTypeId; } }
            public CombatActionTypeMapping M_Root { get { return m_root; } }
            public CombatActionTypeMapping M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CombatActionTypeMapping p__parent = null, CombatActionTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
