...
{
    public partial class CombatShoutType : KaitaiStruct
    {
        public static CombatShoutType FromFile(string fileName)
        {
            return new CombatShoutType(new KaitaiStream(fileName));
        }

        public CombatShoutType(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatShoutType p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatShoutType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatShoutType m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CombatShoutType M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatShoutType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CombatShoutType p__parent = null, CombatShoutType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _combatShoutTypeId = m_io.ReadS4le();
                _combatShoutTypeName = m_io.ReadS4le();
                _metaroleId = m_io.ReadS4le();
                _period = m_io.ReadF4le();
                _periodRndSpread = m_io.ReadF4le();
            }
            private int _combatShoutTypeId;
            private int _combatShoutTypeName;
            private int _metaroleId;
            private float _period;
            private float _periodRndSpread;
            private CombatShoutType m_root;
            private CombatShoutType m_parent;
            public int CombatShoutTypeId { get { return _combatShoutTypeId; } }
            public int CombatShoutTypeName { get { return _combatShoutTypeName; } }
            public int MetaroleId { get { return _metaroleId; } }
            public float Period { get { return _period; } }
            public float PeriodRndSpread { get { return _periodRndSpread; } }
            public CombatShoutType M_Root { get { return m_root; } }
            public CombatShoutType M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatShoutType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatShoutType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CombatShoutType p__parent = null, CombatShoutType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatShoutType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatShoutType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
