...
{
    public partial class AlchemyBase : KaitaiStruct
    {
        public static AlchemyBase FromFile(string fileName)
        {
            return new AlchemyBase(new KaitaiStream(fileName));
        }

        public AlchemyBase(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyBase p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, AlchemyBase.Row p__parent = null, AlchemyBase p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AlchemyBase m_root;
            private AlchemyBase.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public AlchemyBase M_Root { get { return m_root; } }
            public AlchemyBase.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyBase p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, AlchemyBase p__parent = null, AlchemyBase p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private int _uiName;
            private AlchemyBase m_root;
            private AlchemyBase m_parent;
            public Uuid ItemId { get { return _itemId; } }
            public int UiName { get { return _uiName; } }
            public AlchemyBase M_Root { get { return m_root; } }
            public AlchemyBase M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyBase p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyBase p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, AlchemyBase p__parent = null, AlchemyBase p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyBase p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, AlchemyBase p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
