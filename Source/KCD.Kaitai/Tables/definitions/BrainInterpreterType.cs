...
{
    public partial class BrainInterpreterType : KaitaiStruct
    {
        public static BrainInterpreterType FromFile(string fileName)
        {
            return new BrainInterpreterType(new KaitaiStream(fileName));
        }

        public BrainInterpreterType(KaitaiStream p__io, KaitaiStruct p__parent = null, BrainInterpreterType p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, BrainInterpreterType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private BrainInterpreterType m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public BrainInterpreterType M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, BrainInterpreterType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, BrainInterpreterType p__parent = null, BrainInterpreterType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _brainInterpreterTypeId = m_io.ReadS4le();
                _brainInterpreterTypeName = m_io.ReadS4le();
            }
            private int _brainInterpreterTypeId;
            private int _brainInterpreterTypeName;
            private BrainInterpreterType m_root;
            private BrainInterpreterType m_parent;
            public int BrainInterpreterTypeId { get { return _brainInterpreterTypeId; } }
            public int BrainInterpreterTypeName { get { return _brainInterpreterTypeName; } }
            public BrainInterpreterType M_Root { get { return m_root; } }
            public BrainInterpreterType M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, BrainInterpreterType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, BrainInterpreterType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, BrainInterpreterType p__parent = null, BrainInterpreterType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, BrainInterpreterType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, BrainInterpreterType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
