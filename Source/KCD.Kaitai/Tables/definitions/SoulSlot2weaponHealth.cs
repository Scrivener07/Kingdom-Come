...
{
    public partial class SoulSlot2weaponHealth : KaitaiStruct
    {
        public static SoulSlot2weaponHealth FromFile(string fileName)
        {
            return new SoulSlot2weaponHealth(new KaitaiStream(fileName));
        }

        public SoulSlot2weaponHealth(KaitaiStream p__io, KaitaiStruct p__parent = null, SoulSlot2weaponHealth p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, SoulSlot2weaponHealth.Row p__parent = null, SoulSlot2weaponHealth p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SoulSlot2weaponHealth m_root;
            private SoulSlot2weaponHealth.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public SoulSlot2weaponHealth M_Root { get { return m_root; } }
            public SoulSlot2weaponHealth.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, SoulSlot2weaponHealth p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SoulSlot2weaponHealth p__parent = null, SoulSlot2weaponHealth p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SoulSlot2weaponHealth p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SoulSlot2weaponHealth p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SoulSlot2weaponHealth p__parent = null, SoulSlot2weaponHealth p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SoulSlot2weaponHealth p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SoulSlot2weaponHealth p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
