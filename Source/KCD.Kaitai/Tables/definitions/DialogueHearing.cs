...
{
    public partial class DialogueHearing : KaitaiStruct
    {
        public static DialogueHearing FromFile(string fileName)
        {
            return new DialogueHearing(new KaitaiStream(fileName));
        }

        public DialogueHearing(KaitaiStream p__io, KaitaiStruct p__parent = null, DialogueHearing p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, DialogueHearing p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private DialogueHearing m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public DialogueHearing M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, DialogueHearing p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, DialogueHearing p__parent = null, DialogueHearing p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _dialogueHearingId = m_io.ReadS4le();
                _dialogueHearingName = m_io.ReadS4le();
            }
            private int _dialogueHearingId;
            private int _dialogueHearingName;
            private DialogueHearing m_root;
            private DialogueHearing m_parent;
            public int DialogueHearingId { get { return _dialogueHearingId; } }
            public int DialogueHearingName { get { return _dialogueHearingName; } }
            public DialogueHearing M_Root { get { return m_root; } }
            public DialogueHearing M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, DialogueHearing p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, DialogueHearing p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, DialogueHearing p__parent = null, DialogueHearing p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, DialogueHearing p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, DialogueHearing p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
