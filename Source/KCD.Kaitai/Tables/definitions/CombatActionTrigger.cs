...
{
    public partial class CombatActionTrigger : KaitaiStruct
    {
        public static CombatActionTrigger FromFile(string fileName)
        {
            return new CombatActionTrigger(new KaitaiStream(fileName));
        }

        public CombatActionTrigger(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionTrigger p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionTrigger p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionTrigger m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CombatActionTrigger M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionTrigger p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CombatActionTrigger p__parent = null, CombatActionTrigger p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _combatActionTriggerId = m_io.ReadS4le();
                _combatGuardTypeId = m_io.ReadS4le();
                _combatInputClassId = m_io.ReadS4le();
                _timeout = m_io.ReadF4le();
                _combatActionTypeId = m_io.ReadS4le();
            }
            private int _combatActionTriggerId;
            private int _combatGuardTypeId;
            private int _combatInputClassId;
            private float _timeout;
            private int _combatActionTypeId;
            private CombatActionTrigger m_root;
            private CombatActionTrigger m_parent;
            public int CombatActionTriggerId { get { return _combatActionTriggerId; } }
            ...
            public CombatActionTrigger M_Root { get { return m_root; } }
            public CombatActionTrigger M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionTrigger p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionTrigger p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CombatActionTrigger p__parent = null, CombatActionTrigger p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionTrigger p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionTrigger p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
