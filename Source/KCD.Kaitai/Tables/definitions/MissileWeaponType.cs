...
{
    public partial class MissileWeaponType : KaitaiStruct
    {
        public static MissileWeaponType FromFile(string fileName)
        {
            return new MissileWeaponType(new KaitaiStream(fileName));
        }

        public MissileWeaponType(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeaponType p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private MissileWeaponType m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public MissileWeaponType M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, MissileWeaponType p__parent = null, MissileWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _missileWeaponTypeId = m_io.ReadS4le();
                _missileWeaponTypeName = m_io.ReadS4le();
            }
            private int _missileWeaponTypeId;
            private int _missileWeaponTypeName;
            private MissileWeaponType m_root;
            private MissileWeaponType m_parent;
            public int MissileWeaponTypeId { get { return _missileWeaponTypeId; } }
            public int MissileWeaponTypeName { get { return _missileWeaponTypeName; } }
            public MissileWeaponType M_Root { get { return m_root; } }
            public MissileWeaponType M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, MissileWeaponType p__parent = null, MissileWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
