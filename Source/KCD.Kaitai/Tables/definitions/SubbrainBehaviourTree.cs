...
{
    public partial class SubbrainBehaviourTree : KaitaiStruct
    {
        public static SubbrainBehaviourTree FromFile(string fileName)
        {
            return new SubbrainBehaviourTree(new KaitaiStream(fileName));
        }

        public SubbrainBehaviourTree(KaitaiStream p__io, KaitaiStruct p__parent = null, SubbrainBehaviourTree p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, SubbrainBehaviourTree.Row p__parent = null, SubbrainBehaviourTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SubbrainBehaviourTree m_root;
            private SubbrainBehaviourTree.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public SubbrainBehaviourTree M_Root { get { return m_root; } }
            public SubbrainBehaviourTree.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, SubbrainBehaviourTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SubbrainBehaviourTree p__parent = null, SubbrainBehaviourTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SubbrainBehaviourTree m_root;
            private SubbrainBehaviourTree m_parent;
            ...
            public SubbrainBehaviourTree M_Root { get { return m_root; } }
            public SubbrainBehaviourTree M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SubbrainBehaviourTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SubbrainBehaviourTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SubbrainBehaviourTree p__parent = null, SubbrainBehaviourTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SubbrainBehaviourTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SubbrainBehaviourTree p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
