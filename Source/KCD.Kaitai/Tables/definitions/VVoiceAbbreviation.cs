...
{
    public partial class VVoiceAbbreviation : KaitaiStruct
    {
        public static VVoiceAbbreviation FromFile(string fileName)
        {
            return new VVoiceAbbreviation(new KaitaiStream(fileName));
        }

        public VVoiceAbbreviation(KaitaiStream p__io, KaitaiStruct p__parent = null, VVoiceAbbreviation p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, VVoiceAbbreviation p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private VVoiceAbbreviation m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public VVoiceAbbreviation M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, VVoiceAbbreviation p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, VVoiceAbbreviation p__parent = null, VVoiceAbbreviation p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _abbreviation = m_io.ReadS4le();
            }
            private int _voiceId;
            private int _abbreviation;
            private VVoiceAbbreviation m_root;
            private VVoiceAbbreviation m_parent;
            public int VoiceId { get { return _voiceId; } }
            public int Abbreviation { get { return _abbreviation; } }
            public VVoiceAbbreviation M_Root { get { return m_root; } }
            public VVoiceAbbreviation M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, VVoiceAbbreviation p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, VVoiceAbbreviation p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, VVoiceAbbreviation p__parent = null, VVoiceAbbreviation p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, VVoiceAbbreviation p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, VVoiceAbbreviation p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
