...
{
    public partial class CombatSyncActionHit : KaitaiStruct
    {
        public static CombatSyncActionHit FromFile(string fileName)
        {
            return new CombatSyncActionHit(new KaitaiStream(fileName));
        }

        public CombatSyncActionHit(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatSyncActionHit p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatSyncActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatSyncActionHit m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CombatSyncActionHit M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatSyncActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CombatSyncActionHit p__parent = null, CombatSyncActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _forcedBodySubpartId = m_io.ReadS4le();
                _attackValueCoef = m_io.ReadF4le();
            }
            private int _mnFragmentId;
            private int _order;
            private int _forcedBodySubpartId;
            private float _attackValueCoef;
            private CombatSyncActionHit m_root;
            private CombatSyncActionHit m_parent;
            public int MnFragmentId { get { return _mnFragmentId; } }
            public int Order { get { return _order; } }
            public int ForcedBodySubpartId { get { return _forcedBodySubpartId; } }
            public float AttackValueCoef { get { return _attackValueCoef; } }
            public CombatSyncActionHit M_Root { get { return m_root; } }
            public CombatSyncActionHit M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatSyncActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatSyncActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CombatSyncActionHit p__parent = null, CombatSyncActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatSyncActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatSyncActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
