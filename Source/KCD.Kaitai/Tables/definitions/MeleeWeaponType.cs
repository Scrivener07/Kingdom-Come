...
{
    public partial class MeleeWeaponType : KaitaiStruct
    {
        public static MeleeWeaponType FromFile(string fileName)
        {
            return new MeleeWeaponType(new KaitaiStream(fileName));
        }

        public MeleeWeaponType(KaitaiStream p__io, KaitaiStruct p__parent = null, MeleeWeaponType p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, MeleeWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private MeleeWeaponType m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public MeleeWeaponType M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, MeleeWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, MeleeWeaponType p__parent = null, MeleeWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _meleeWeaponTypeId = m_io.ReadS4le();
                _meleeWeaponTypeName = m_io.ReadS4le();
            }
            private int _meleeWeaponTypeId;
            private int _meleeWeaponTypeName;
            private MeleeWeaponType m_root;
            private MeleeWeaponType m_parent;
            public int MeleeWeaponTypeId { get { return _meleeWeaponTypeId; } }
            public int MeleeWeaponTypeName { get { return _meleeWeaponTypeName; } }
            public MeleeWeaponType M_Root { get { return m_root; } }
            public MeleeWeaponType M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, MeleeWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, MeleeWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, MeleeWeaponType p__parent = null, MeleeWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, MeleeWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, MeleeWeaponType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
