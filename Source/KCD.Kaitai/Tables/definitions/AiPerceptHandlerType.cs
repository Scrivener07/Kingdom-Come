...
{
    public partial class AiPerceptHandlerType : KaitaiStruct
    {
        public static AiPerceptHandlerType FromFile(string fileName)
        {
            return new AiPerceptHandlerType(new KaitaiStream(fileName));
        }

        public AiPerceptHandlerType(KaitaiStream p__io, KaitaiStruct p__parent = null, AiPerceptHandlerType p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, AiPerceptHandlerType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AiPerceptHandlerType m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public AiPerceptHandlerType M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, AiPerceptHandlerType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, AiPerceptHandlerType p__parent = null, AiPerceptHandlerType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _aiPerceptHandlerTypeId = m_io.ReadS4le();
                _aiPerceptHandlerTypeName = m_io.ReadS4le();
            }
            private int _aiPerceptHandlerTypeId;
            private int _aiPerceptHandlerTypeName;
            private AiPerceptHandlerType m_root;
            private AiPerceptHandlerType m_parent;
            public int AiPerceptHandlerTypeId { get { return _aiPerceptHandlerTypeId; } }
            public int AiPerceptHandlerTypeName { get { return _aiPerceptHandlerTypeName; } }
            public AiPerceptHandlerType M_Root { get { return m_root; } }
            public AiPerceptHandlerType M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, AiPerceptHandlerType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, AiPerceptHandlerType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, AiPerceptHandlerType p__parent = null, AiPerceptHandlerType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, AiPerceptHandlerType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, AiPerceptHandlerType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
