...
{
    public partial class AiVariableSync : KaitaiStruct
    {
        public static AiVariableSync FromFile(string fileName)
        {
            return new AiVariableSync(new KaitaiStream(fileName));
        }

        public AiVariableSync(KaitaiStream p__io, KaitaiStruct p__parent = null, AiVariableSync p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, AiVariableSync p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AiVariableSync m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public AiVariableSync M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, AiVariableSync p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, AiVariableSync p__parent = null, AiVariableSync p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _aiVariableSyncName = m_io.ReadS4le();
            }
            private int _aiVariableSyncId;
            private int _aiVariableSyncName;
            private AiVariableSync m_root;
            private AiVariableSync m_parent;
            public int AiVariableSyncId { get { return _aiVariableSyncId; } }
            public int AiVariableSyncName { get { return _aiVariableSyncName; } }
            public AiVariableSync M_Root { get { return m_root; } }
            public AiVariableSync M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, AiVariableSync p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, AiVariableSync p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, AiVariableSync p__parent = null, AiVariableSync p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, AiVariableSync p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, AiVariableSync p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
