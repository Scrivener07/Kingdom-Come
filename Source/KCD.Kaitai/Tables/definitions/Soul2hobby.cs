...
{
    public partial class Soul2hobby : KaitaiStruct
    {
        public static Soul2hobby FromFile(string fileName)
        {
            return new Soul2hobby(new KaitaiStream(fileName));
        }

        public Soul2hobby(KaitaiStream p__io, KaitaiStruct p__parent = null, Soul2hobby p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, Soul2hobby.Row p__parent = null, Soul2hobby p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private Soul2hobby m_root;
            private Soul2hobby.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public Soul2hobby M_Root { get { return m_root; } }
            public Soul2hobby.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, Soul2hobby p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, Soul2hobby p__parent = null, Soul2hobby p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private float _mass;
            private Soul2hobby m_root;
            private Soul2hobby m_parent;
            public Uuid SoulId { get { return _soulId; } }
            public int HobbyId { get { return _hobbyId; } }
            public float Mass { get { return _mass; } }
            public Soul2hobby M_Root { get { return m_root; } }
            public Soul2hobby M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, Soul2hobby p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, Soul2hobby p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, Soul2hobby p__parent = null, Soul2hobby p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, Soul2hobby p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, Soul2hobby p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
