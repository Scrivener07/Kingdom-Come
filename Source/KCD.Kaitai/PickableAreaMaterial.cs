...
{
    public partial class PickableAreaMaterial : KaitaiStruct
    {
        public static PickableAreaMaterial FromFile(string fileName)
        {
            return new PickableAreaMaterial(new KaitaiStream(fileName));
        }

        public PickableAreaMaterial(KaitaiStream p__io, KaitaiStruct p__parent = null, PickableAreaMaterial p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, PickableAreaMaterial p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private PickableAreaMaterial m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public PickableAreaMaterial M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, PickableAreaMaterial p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, PickableAreaMaterial p__parent = null, PickableAreaMaterial p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _pickableAreaId = m_io.ReadS4le();
                _materialName = m_io.ReadS4le();
            }
            private int _pickableAreaId;
            private int _materialName;
            private PickableAreaMaterial m_root;
            private PickableAreaMaterial m_parent;
            public int PickableAreaId { get { return _pickableAreaId; } }
            public int MaterialName { get { return _materialName; } }
            public PickableAreaMaterial M_Root { get { return m_root; } }
            public PickableAreaMaterial M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, PickableAreaMaterial p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, PickableAreaMaterial p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, PickableAreaMaterial p__parent = null, PickableAreaMaterial p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, PickableAreaMaterial p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, PickableAreaMaterial p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
