...
{
    public partial class ReadingSpotType : KaitaiStruct
    {
        public static ReadingSpotType FromFile(string fileName)
        {
            return new ReadingSpotType(new KaitaiStream(fileName));
        }

        public ReadingSpotType(KaitaiStream p__io, KaitaiStruct p__parent = null, ReadingSpotType p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, ReadingSpotType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private ReadingSpotType m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public ReadingSpotType M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, ReadingSpotType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, ReadingSpotType p__parent = null, ReadingSpotType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _readingSpotTypeId = m_io.ReadS4le();
                _readingSpotTypeName = m_io.ReadS4le();
                _readingBonus = m_io.ReadF4le();
            }
            private int _readingSpotTypeId;
            private int _readingSpotTypeName;
            private float _readingBonus;
            private ReadingSpotType m_root;
            private ReadingSpotType m_parent;
            public int ReadingSpotTypeId { get { return _readingSpotTypeId; } }
            public int ReadingSpotTypeName { get { return _readingSpotTypeName; } }
            public float ReadingBonus { get { return _readingBonus; } }
            public ReadingSpotType M_Root { get { return m_root; } }
            public ReadingSpotType M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, ReadingSpotType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, ReadingSpotType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, ReadingSpotType p__parent = null, ReadingSpotType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, ReadingSpotType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, ReadingSpotType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
