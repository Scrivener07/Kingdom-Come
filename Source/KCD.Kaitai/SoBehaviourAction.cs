...
{
    public partial class SoBehaviourAction : KaitaiStruct
    {
        public static SoBehaviourAction FromFile(string fileName)
        {
            return new SoBehaviourAction(new KaitaiStream(fileName));
        }

        public SoBehaviourAction(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourAction p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourAction p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SoBehaviourAction m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public SoBehaviourAction M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourAction p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SoBehaviourAction p__parent = null, SoBehaviourAction p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _soBehaviourActionId = m_io.ReadS4le();
                _soBehaviourActionName = m_io.ReadS4le();
            }
            private int _soBehaviourActionId;
            private int _soBehaviourActionName;
            private SoBehaviourAction m_root;
            private SoBehaviourAction m_parent;
            public int SoBehaviourActionId { get { return _soBehaviourActionId; } }
            public int SoBehaviourActionName { get { return _soBehaviourActionName; } }
            public SoBehaviourAction M_Root { get { return m_root; } }
            public SoBehaviourAction M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourAction p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourAction p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SoBehaviourAction p__parent = null, SoBehaviourAction p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourAction p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SoBehaviourAction p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
