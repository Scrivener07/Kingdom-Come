...
{
    public partial class PerkSoulAbility : KaitaiStruct
    {
        public static PerkSoulAbility FromFile(string fileName)
        {
            return new PerkSoulAbility(new KaitaiStream(fileName));
        }

        public PerkSoulAbility(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkSoulAbility p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, PerkSoulAbility.Row p__parent = null, PerkSoulAbility p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private PerkSoulAbility m_root;
            private PerkSoulAbility.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public PerkSoulAbility M_Root { get { return m_root; } }
            public PerkSoulAbility.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkSoulAbility p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, PerkSoulAbility p__parent = null, PerkSoulAbility p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _soulAbilityId = m_io.ReadS4le();
            }
            private Uuid _perkId;
            private int _soulAbilityId;
            private PerkSoulAbility m_root;
            private PerkSoulAbility m_parent;
            public Uuid PerkId { get { return _perkId; } }
            public int SoulAbilityId { get { return _soulAbilityId; } }
            public PerkSoulAbility M_Root { get { return m_root; } }
            public PerkSoulAbility M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkSoulAbility p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkSoulAbility p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, PerkSoulAbility p__parent = null, PerkSoulAbility p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkSoulAbility p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkSoulAbility p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
