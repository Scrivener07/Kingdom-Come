...
{
    public partial class QuestSoulMortality : KaitaiStruct
    {
        public static QuestSoulMortality FromFile(string fileName)
        {
            return new QuestSoulMortality(new KaitaiStream(fileName));
        }

        public QuestSoulMortality(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestSoulMortality p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, QuestSoulMortality.Row p__parent = null, QuestSoulMortality p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private QuestSoulMortality m_root;
            private QuestSoulMortality.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public QuestSoulMortality M_Root { get { return m_root; } }
            public QuestSoulMortality.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestSoulMortality p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, QuestSoulMortality p__parent = null, QuestSoulMortality p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private QuestSoulMortality m_root;
            private QuestSoulMortality m_parent;
            public Uuid SoulId { get { return _soulId; } }
            public int QuestId { get { return _questId; } }
            public QuestSoulMortality M_Root { get { return m_root; } }
            public QuestSoulMortality M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestSoulMortality p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestSoulMortality p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, QuestSoulMortality p__parent = null, QuestSoulMortality p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestSoulMortality p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestSoulMortality p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
