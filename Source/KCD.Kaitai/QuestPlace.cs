...
{
    public partial class QuestPlace : KaitaiStruct
    {
        public static QuestPlace FromFile(string fileName)
        {
            return new QuestPlace(new KaitaiStream(fileName));
        }

        public QuestPlace(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestPlace p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestPlace p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private QuestPlace m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public QuestPlace M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestPlace p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, QuestPlace p__parent = null, QuestPlace p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _map = m_io.ReadS4le();
                _entity = m_io.ReadS4le();
                _showAsArea = m_io.ReadS1();
            }
            private int _questAssetId;
            private int _questId;
            private int _map;
            private int _entity;
            private sbyte _showAsArea;
            private QuestPlace m_root;
            private QuestPlace m_parent;
            public int QuestAssetId { get { return _questAssetId; } }
            public int QuestId { get { return _questId; } }
            public int Map { get { return _map; } }
            public int Entity { get { return _entity; } }
            public sbyte ShowAsArea { get { return _showAsArea; } }
            public QuestPlace M_Root { get { return m_root; } }
            public QuestPlace M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestPlace p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestPlace p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, QuestPlace p__parent = null, QuestPlace p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestPlace p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, QuestPlace p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
