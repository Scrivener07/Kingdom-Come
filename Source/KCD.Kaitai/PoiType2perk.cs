...
{
    public partial class PoiType2perk : KaitaiStruct
    {
        public static PoiType2perk FromFile(string fileName)
        {
            return new PoiType2perk(new KaitaiStream(fileName));
        }

        public PoiType2perk(KaitaiStream p__io, KaitaiStruct p__parent = null, PoiType2perk p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, PoiType2perk.Row p__parent = null, PoiType2perk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private PoiType2perk m_root;
            private PoiType2perk.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public PoiType2perk M_Root { get { return m_root; } }
            public PoiType2perk.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, PoiType2perk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, PoiType2perk p__parent = null, PoiType2perk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _poiTypeId = new Uuid(m_io, this, m_root);
                _perkId = new Uuid(m_io, this, m_root);
            }
            private Uuid _poiTypeId;
            private Uuid _perkId;
            private PoiType2perk m_root;
            private PoiType2perk m_parent;
            public Uuid PoiTypeId { get { return _poiTypeId; } }
            public Uuid PerkId { get { return _perkId; } }
            public PoiType2perk M_Root { get { return m_root; } }
            public PoiType2perk M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, PoiType2perk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, PoiType2perk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, PoiType2perk p__parent = null, PoiType2perk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, PoiType2perk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, PoiType2perk p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
