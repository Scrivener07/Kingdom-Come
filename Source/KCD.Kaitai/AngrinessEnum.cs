...
{
    public partial class AngrinessEnum : KaitaiStruct
    {
        public static AngrinessEnum FromFile(string fileName)
        {
            return new AngrinessEnum(new KaitaiStream(fileName));
        }

        public AngrinessEnum(KaitaiStream p__io, KaitaiStruct p__parent = null, AngrinessEnum p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, AngrinessEnum p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AngrinessEnum m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public AngrinessEnum M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, AngrinessEnum p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, AngrinessEnum p__parent = null, AngrinessEnum p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _angrinessEnumId = m_io.ReadS4le();
                _name = m_io.ReadS4le();
                _value = m_io.ReadF4le();
            }
            private int _angrinessEnumId;
            private int _name;
            private float _value;
            private AngrinessEnum m_root;
            private AngrinessEnum m_parent;
            public int AngrinessEnumId { get { return _angrinessEnumId; } }
            public int Name { get { return _name; } }
            public float Value { get { return _value; } }
            public AngrinessEnum M_Root { get { return m_root; } }
            public AngrinessEnum M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, AngrinessEnum p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, AngrinessEnum p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, AngrinessEnum p__parent = null, AngrinessEnum p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, AngrinessEnum p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, AngrinessEnum p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
