...
{
    public partial class CombatActionFailedAttack : KaitaiStruct
    {
        public static CombatActionFailedAttack FromFile(string fileName)
        {
            return new CombatActionFailedAttack(new KaitaiStream(fileName));
        }

        public CombatActionFailedAttack(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionFailedAttack p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionFailedAttack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionFailedAttack m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CombatActionFailedAttack M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionFailedAttack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CombatActionFailedAttack p__parent = null, CombatActionFailedAttack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private int _mnTags;
            private CombatActionFailedAttack m_root;
            private CombatActionFailedAttack m_parent;
            ...
            public CombatActionFailedAttack M_Root { get { return m_root; } }
            public CombatActionFailedAttack M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionFailedAttack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, CombatActionFailedAttack.Row p__parent = null, CombatActionFailedAttack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionFailedAttack m_root;
            private CombatActionFailedAttack.Row m_parent;
            public byte[] QuattType { get { return _quattType; } }
            public CombatActionFailedAttack M_Root { get { return m_root; } }
            public CombatActionFailedAttack.Row M_Parent { get { return m_parent; } }
        }
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CombatActionFailedAttack p__parent = null, CombatActionFailedAttack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionFailedAttack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionFailedAttack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
