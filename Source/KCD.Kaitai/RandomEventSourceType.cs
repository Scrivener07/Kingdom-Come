...
{
    public partial class RandomEventSourceType : KaitaiStruct
    {
        public static RandomEventSourceType FromFile(string fileName)
        {
            return new RandomEventSourceType(new KaitaiStream(fileName));
        }

        public RandomEventSourceType(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventSourceType p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventSourceType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private RandomEventSourceType m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public RandomEventSourceType M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventSourceType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, RandomEventSourceType p__parent = null, RandomEventSourceType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _randomEventSourceTypeName = m_io.ReadS4le();
            }
            private int _randomEventSourceTypeId;
            private int _randomEventSourceTypeName;
            private RandomEventSourceType m_root;
            private RandomEventSourceType m_parent;
            public int RandomEventSourceTypeId { get { return _randomEventSourceTypeId; } }
            public int RandomEventSourceTypeName { get { return _randomEventSourceTypeName; } }
            public RandomEventSourceType M_Root { get { return m_root; } }
            public RandomEventSourceType M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventSourceType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventSourceType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, RandomEventSourceType p__parent = null, RandomEventSourceType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventSourceType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventSourceType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
