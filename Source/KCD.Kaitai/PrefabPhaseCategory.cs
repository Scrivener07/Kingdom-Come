...
{
    public partial class PrefabPhaseCategory : KaitaiStruct
    {
        public static PrefabPhaseCategory FromFile(string fileName)
        {
            return new PrefabPhaseCategory(new KaitaiStream(fileName));
        }

        public PrefabPhaseCategory(KaitaiStream p__io, KaitaiStruct p__parent = null, PrefabPhaseCategory p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, PrefabPhaseCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private PrefabPhaseCategory m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public PrefabPhaseCategory M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, PrefabPhaseCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, PrefabPhaseCategory p__parent = null, PrefabPhaseCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _prefabPhaseCategoryName = m_io.ReadS4le();
            }
            private int _prefabPhaseCategoryId;
            private int _prefabPhaseCategoryName;
            private PrefabPhaseCategory m_root;
            private PrefabPhaseCategory m_parent;
            public int PrefabPhaseCategoryId { get { return _prefabPhaseCategoryId; } }
            public int PrefabPhaseCategoryName { get { return _prefabPhaseCategoryName; } }
            public PrefabPhaseCategory M_Root { get { return m_root; } }
            public PrefabPhaseCategory M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, PrefabPhaseCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, PrefabPhaseCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, PrefabPhaseCategory p__parent = null, PrefabPhaseCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, PrefabPhaseCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, PrefabPhaseCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
