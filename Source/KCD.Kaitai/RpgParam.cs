...
{
    public partial class RpgParam : KaitaiStruct
    {
        public static RpgParam FromFile(string fileName)
        {
            return new RpgParam(new KaitaiStream(fileName));
        }

        public RpgParam(KaitaiStream p__io, KaitaiStruct p__parent = null, RpgParam p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, RpgParam p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private RpgParam m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public RpgParam M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, RpgParam p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, RpgParam p__parent = null, RpgParam p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _rpgParamKey = m_io.ReadS4le();
                _rpgParamValue = m_io.ReadF4le();
            }
            private int _rpgParamKey;
            private float _rpgParamValue;
            private RpgParam m_root;
            private RpgParam m_parent;
            public int RpgParamKey { get { return _rpgParamKey; } }
            public float RpgParamValue { get { return _rpgParamValue; } }
            public RpgParam M_Root { get { return m_root; } }
            public RpgParam M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, RpgParam p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, RpgParam p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, RpgParam p__parent = null, RpgParam p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, RpgParam p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, RpgParam p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
