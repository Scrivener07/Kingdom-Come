...
{
    public partial class MissileWeaponClass2ammoClass : KaitaiStruct
    {
        public static MissileWeaponClass2ammoClass FromFile(string fileName)
        {
            return new MissileWeaponClass2ammoClass(new KaitaiStream(fileName));
        }

        public MissileWeaponClass2ammoClass(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeaponClass2ammoClass p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeaponClass2ammoClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private MissileWeaponClass2ammoClass m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public MissileWeaponClass2ammoClass M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeaponClass2ammoClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, MissileWeaponClass2ammoClass p__parent = null, MissileWeaponClass2ammoClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _missileWeaponClassId = m_io.ReadS4le();
                _ammoClassId = m_io.ReadS4le();
            }
            private int _missileWeaponClassId;
            private int _ammoClassId;
            private MissileWeaponClass2ammoClass m_root;
            private MissileWeaponClass2ammoClass m_parent;
            public int MissileWeaponClassId { get { return _missileWeaponClassId; } }
            public int AmmoClassId { get { return _ammoClassId; } }
            public MissileWeaponClass2ammoClass M_Root { get { return m_root; } }
            public MissileWeaponClass2ammoClass M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeaponClass2ammoClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeaponClass2ammoClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, MissileWeaponClass2ammoClass p__parent = null, MissileWeaponClass2ammoClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeaponClass2ammoClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, MissileWeaponClass2ammoClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
