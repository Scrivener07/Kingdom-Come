...
{
    public partial class AttachmentSlot : KaitaiStruct
    {
        public static AttachmentSlot FromFile(string fileName)
        {
            return new AttachmentSlot(new KaitaiStream(fileName));
        }

        public AttachmentSlot(KaitaiStream p__io, KaitaiStruct p__parent = null, AttachmentSlot p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, AttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AttachmentSlot m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public AttachmentSlot M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, AttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, AttachmentSlot p__parent = null, AttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _attachmentSlotName = m_io.ReadS4le();
                _jointName = m_io.ReadS4le();
                _raceId = m_io.ReadS4le();
            }
            private int _attachmentSlotId;
            private int _attachmentSlotName;
            private int _jointName;
            private int _raceId;
            private AttachmentSlot m_root;
            private AttachmentSlot m_parent;
            public int AttachmentSlotId { get { return _attachmentSlotId; } }
            public int AttachmentSlotName { get { return _attachmentSlotName; } }
            public int JointName { get { return _jointName; } }
            public int RaceId { get { return _raceId; } }
            public AttachmentSlot M_Root { get { return m_root; } }
            public AttachmentSlot M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, AttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, AttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, AttachmentSlot p__parent = null, AttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, AttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, AttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
