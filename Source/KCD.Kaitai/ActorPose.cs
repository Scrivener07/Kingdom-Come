...
{
    public partial class ActorPose : KaitaiStruct
    {
        public static ActorPose FromFile(string fileName)
        {
            return new ActorPose(new KaitaiStream(fileName));
        }

        public ActorPose(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorPose p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorPose p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private ActorPose m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public ActorPose M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorPose p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, ActorPose p__parent = null, ActorPose p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _actorPoseName = m_io.ReadS4le();
                _actorPoseMnTag = m_io.ReadS4le();
            }
            private int _actorPoseId;
            private int _actorPoseName;
            private int _actorPoseMnTag;
            private ActorPose m_root;
            private ActorPose m_parent;
            public int ActorPoseId { get { return _actorPoseId; } }
            public int ActorPoseName { get { return _actorPoseName; } }
            public int ActorPoseMnTag { get { return _actorPoseMnTag; } }
            public ActorPose M_Root { get { return m_root; } }
            public ActorPose M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorPose p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorPose p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, ActorPose p__parent = null, ActorPose p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorPose p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorPose p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
