...
{
    public partial class RandomEventOptionSet : KaitaiStruct
    {
        public static RandomEventOptionSet FromFile(string fileName)
        {
            return new RandomEventOptionSet(new KaitaiStream(fileName));
        }

        public RandomEventOptionSet(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventOptionSet p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventOptionSet p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private RandomEventOptionSet m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public RandomEventOptionSet M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventOptionSet p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, RandomEventOptionSet p__parent = null, RandomEventOptionSet p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _randomEventOptionSetName = m_io.ReadS4le();
            }
            private int _randomEventOptionSetId;
            private int _randomEventOptionSetName;
            private RandomEventOptionSet m_root;
            private RandomEventOptionSet m_parent;
            public int RandomEventOptionSetId { get { return _randomEventOptionSetId; } }
            public int RandomEventOptionSetName { get { return _randomEventOptionSetName; } }
            public RandomEventOptionSet M_Root { get { return m_root; } }
            public RandomEventOptionSet M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventOptionSet p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventOptionSet p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, RandomEventOptionSet p__parent = null, RandomEventOptionSet p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventOptionSet p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, RandomEventOptionSet p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
