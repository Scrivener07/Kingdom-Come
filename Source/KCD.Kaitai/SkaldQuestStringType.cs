...
{
    public partial class SkaldQuestStringType : KaitaiStruct
    {
        public static SkaldQuestStringType FromFile(string fileName)
        {
            return new SkaldQuestStringType(new KaitaiStream(fileName));
        }

        public SkaldQuestStringType(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldQuestStringType p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldQuestStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SkaldQuestStringType m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public SkaldQuestStringType M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldQuestStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SkaldQuestStringType p__parent = null, SkaldQuestStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _skaldQuestStringTypeId = m_io.ReadS4le();
                _skaldQuestStringTypeName = m_io.ReadS4le();
            }
            private int _skaldQuestStringTypeId;
            private int _skaldQuestStringTypeName;
            private SkaldQuestStringType m_root;
            private SkaldQuestStringType m_parent;
            public int SkaldQuestStringTypeId { get { return _skaldQuestStringTypeId; } }
            public int SkaldQuestStringTypeName { get { return _skaldQuestStringTypeName; } }
            public SkaldQuestStringType M_Root { get { return m_root; } }
            public SkaldQuestStringType M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldQuestStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldQuestStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SkaldQuestStringType p__parent = null, SkaldQuestStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldQuestStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SkaldQuestStringType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
