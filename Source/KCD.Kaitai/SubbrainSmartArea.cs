...
{
    public partial class SubbrainSmartArea : KaitaiStruct
    {
        public static SubbrainSmartArea FromFile(string fileName)
        {
            return new SubbrainSmartArea(new KaitaiStream(fileName));
        }

        public SubbrainSmartArea(KaitaiStream p__io, KaitaiStruct p__parent = null, SubbrainSmartArea p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, SubbrainSmartArea.Row p__parent = null, SubbrainSmartArea p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SubbrainSmartArea m_root;
            private SubbrainSmartArea.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public SubbrainSmartArea M_Root { get { return m_root; } }
            public SubbrainSmartArea.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, SubbrainSmartArea p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SubbrainSmartArea p__parent = null, SubbrainSmartArea p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _onEnterTree = m_io.ReadS4le();
                _onExitTree = m_io.ReadS4le();
            ...
            private int _onEnterTree;
            private int _onExitTree;
            private sbyte _explicitInitialization;
            private sbyte _systemVariables;
            private SubbrainSmartArea m_root;
            private SubbrainSmartArea m_parent;
            ...
            public int OnEnterTree { get { return _onEnterTree; } }
            public int OnExitTree { get { return _onExitTree; } }
            ...
            public SubbrainSmartArea M_Root { get { return m_root; } }
            public SubbrainSmartArea M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SubbrainSmartArea p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SubbrainSmartArea p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SubbrainSmartArea p__parent = null, SubbrainSmartArea p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SubbrainSmartArea p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SubbrainSmartArea p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
