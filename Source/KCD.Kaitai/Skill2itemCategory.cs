...
{
    public partial class Skill2itemCategory : KaitaiStruct
    {
        public static Skill2itemCategory FromFile(string fileName)
        {
            return new Skill2itemCategory(new KaitaiStream(fileName));
        }

        public Skill2itemCategory(KaitaiStream p__io, KaitaiStruct p__parent = null, Skill2itemCategory p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, Skill2itemCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private Skill2itemCategory m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public Skill2itemCategory M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, Skill2itemCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, Skill2itemCategory p__parent = null, Skill2itemCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _itemCategory = m_io.ReadS4le();
            }
            private int _skillId;
            private int _itemCategory;
            private Skill2itemCategory m_root;
            private Skill2itemCategory m_parent;
            public int SkillId { get { return _skillId; } }
            public int ItemCategory { get { return _itemCategory; } }
            public Skill2itemCategory M_Root { get { return m_root; } }
            public Skill2itemCategory M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, Skill2itemCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, Skill2itemCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, Skill2itemCategory p__parent = null, Skill2itemCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, Skill2itemCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, Skill2itemCategory p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
