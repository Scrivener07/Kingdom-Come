...
{
    public partial class SphHighlight : KaitaiStruct
    {
        public static SphHighlight FromFile(string fileName)
        {
            return new SphHighlight(new KaitaiStream(fileName));
        }

        public SphHighlight(KaitaiStream p__io, KaitaiStruct p__parent = null, SphHighlight p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, SphHighlight p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SphHighlight m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public SphHighlight M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, SphHighlight p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SphHighlight p__parent = null, SphHighlight p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _type = m_io.ReadS4le();
                _significance = m_io.ReadS4le();
                _defaultInterest = m_io.ReadS1();
                _startDelta = m_io.ReadS4le();
                _endDelta = m_io.ReadS4le();
                _sphGroupId = m_io.ReadS4le();
            }
            private int _achievementId;
            private int _type;
            private int _significance;
            private sbyte _defaultInterest;
            private int _startDelta;
            private int _endDelta;
            private int _sphGroupId;
            private SphHighlight m_root;
            private SphHighlight m_parent;
            public int AchievementId { get { return _achievementId; } }
            public int Type { get { return _type; } }
            public int Significance { get { return _significance; } }
            public sbyte DefaultInterest { get { return _defaultInterest; } }
            public int StartDelta { get { return _startDelta; } }
            public int EndDelta { get { return _endDelta; } }
            public int SphGroupId { get { return _sphGroupId; } }
            public SphHighlight M_Root { get { return m_root; } }
            public SphHighlight M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SphHighlight p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SphHighlight p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SphHighlight p__parent = null, SphHighlight p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SphHighlight p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SphHighlight p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
