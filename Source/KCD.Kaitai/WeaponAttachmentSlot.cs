...
{
    public partial class WeaponAttachmentSlot : KaitaiStruct
    {
        public static WeaponAttachmentSlot FromFile(string fileName)
        {
            return new WeaponAttachmentSlot(new KaitaiStream(fileName));
        }

        public WeaponAttachmentSlot(KaitaiStream p__io, KaitaiStruct p__parent = null, WeaponAttachmentSlot p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, WeaponAttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private WeaponAttachmentSlot m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public WeaponAttachmentSlot M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, WeaponAttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, WeaponAttachmentSlot p__parent = null, WeaponAttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _weaponAttachmentSlotId = m_io.ReadS4le();
                _weaponAttachmentSlotName = m_io.ReadS4le();
            }
            private int _weaponAttachmentSlotId;
            private int _weaponAttachmentSlotName;
            private WeaponAttachmentSlot m_root;
            private WeaponAttachmentSlot m_parent;
            public int WeaponAttachmentSlotId { get { return _weaponAttachmentSlotId; } }
            public int WeaponAttachmentSlotName { get { return _weaponAttachmentSlotName; } }
            public WeaponAttachmentSlot M_Root { get { return m_root; } }
            public WeaponAttachmentSlot M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, WeaponAttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, WeaponAttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, WeaponAttachmentSlot p__parent = null, WeaponAttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, WeaponAttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, WeaponAttachmentSlot p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
