...
namespace KCD.Kaitai
{
    public partial class AiBody2npcReferencePoint : KaitaiStruct
    {
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, AiBody2npcReferencePoint.Row p__parent = null, AiBody2npcReferencePoint p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private AiBody2npcReferencePoint.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public AiBody2npcReferencePoint M_Root { get { return m_root; } }
            public AiBody2npcReferencePoint.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody2npcReferencePoint p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            private void _read()
            {
                ...
                _npcReferencePointId = new Uuid(m_io, this, m_root);
            }
            private Uuid _aiBodyId;
            private Uuid _npcReferencePointId;
            private AiBody2npcReferencePoint m_root;
            private AiBody2npcReferencePoint m_parent;
            public Uuid AiBodyId { get { return _aiBodyId; } }
            public Uuid NpcReferencePointId { get { return _npcReferencePointId; } }
            public AiBody2npcReferencePoint M_Root { get { return m_root; } }
        ...
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody2npcReferencePoint p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody2npcReferencePoint p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody2npcReferencePoint p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, AiBody2npcReferencePoint p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
