...
{
    public partial class CombatActionHit : KaitaiStruct
    {
        public static CombatActionHit FromFile(string fileName)
        {
            return new CombatActionHit(new KaitaiStream(fileName));
        }

        public CombatActionHit(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionHit p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionHit m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CombatActionHit M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CombatActionHit p__parent = null, CombatActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _brokenBlock = m_io.ReadS1();
                _isWeaponHit = m_io.ReadS1();
                _hitOrigin = m_io.ReadS4le();
                _hitMnFragmentId = m_io.ReadS4le();
                _hitMnOptionIndex = m_io.ReadS4le();
                _hitMnTags = m_io.ReadS4le();
            ...
            private sbyte _brokenBlock;
            private sbyte _isWeaponHit;
            private int _hitOrigin;
            private int _hitMnFragmentId;
            private int _hitMnOptionIndex;
            private int _hitMnTags;
            private sbyte _isFullbody;
            private CombatActionHit m_root;
            private CombatActionHit m_parent;
            ...
            public sbyte BrokenBlock { get { return _brokenBlock; } }
            public sbyte IsWeaponHit { get { return _isWeaponHit; } }
            public int HitOrigin { get { return _hitOrigin; } }
            public int HitMnFragmentId { get { return _hitMnFragmentId; } }
            public int HitMnOptionIndex { get { return _hitMnOptionIndex; } }
            public int HitMnTags { get { return _hitMnTags; } }
            public sbyte IsFullbody { get { return _isFullbody; } }
            public CombatActionHit M_Root { get { return m_root; } }
            public CombatActionHit M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, CombatActionHit.Row p__parent = null, CombatActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatActionHit m_root;
            private CombatActionHit.Row m_parent;
            public byte[] QuattType { get { return _quattType; } }
            public CombatActionHit M_Root { get { return m_root; } }
            public CombatActionHit.Row M_Parent { get { return m_parent; } }
        }
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CombatActionHit p__parent = null, CombatActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatActionHit p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
