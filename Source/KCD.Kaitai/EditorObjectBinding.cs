...
{
    public partial class EditorObjectBinding : KaitaiStruct
    {
        public static EditorObjectBinding FromFile(string fileName)
        {
            return new EditorObjectBinding(new KaitaiStream(fileName));
        }

        public EditorObjectBinding(KaitaiStream p__io, KaitaiStruct p__parent = null, EditorObjectBinding p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, EditorObjectBinding p__parent = null, EditorObjectBinding p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
