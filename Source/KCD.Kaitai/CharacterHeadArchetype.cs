...
{
    public partial class CharacterHeadArchetype : KaitaiStruct
    {
        public static CharacterHeadArchetype FromFile(string fileName)
        {
            return new CharacterHeadArchetype(new KaitaiStream(fileName));
        }

        public CharacterHeadArchetype(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterHeadArchetype p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterHeadArchetype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CharacterHeadArchetype m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CharacterHeadArchetype M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterHeadArchetype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CharacterHeadArchetype p__parent = null, CharacterHeadArchetype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _characterHeadArchetypeName = m_io.ReadS4le();
            }
            private int _characterHeadArchetypeId;
            private int _characterHeadArchetypeName;
            private CharacterHeadArchetype m_root;
            private CharacterHeadArchetype m_parent;
            public int CharacterHeadArchetypeId { get { return _characterHeadArchetypeId; } }
            public int CharacterHeadArchetypeName { get { return _characterHeadArchetypeName; } }
            public CharacterHeadArchetype M_Root { get { return m_root; } }
            public CharacterHeadArchetype M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterHeadArchetype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterHeadArchetype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CharacterHeadArchetype p__parent = null, CharacterHeadArchetype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterHeadArchetype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CharacterHeadArchetype p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
