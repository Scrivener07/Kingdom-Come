...
{
    public partial class CreditPeople : KaitaiStruct
    {
        public static CreditPeople FromFile(string fileName)
        {
            return new CreditPeople(new KaitaiStream(fileName));
        }

        public CreditPeople(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditPeople p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditPeople p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CreditPeople m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CreditPeople M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditPeople p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CreditPeople p__parent = null, CreditPeople p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _creditPeopleId = m_io.ReadS4le();
                _creditPeopleName = m_io.ReadS4le();
                _creditRoleId = m_io.ReadS4le();
                _orderBy = m_io.ReadS4le();
            }
            private int _creditPeopleId;
            private int _creditPeopleName;
            private int _creditRoleId;
            private int _orderBy;
            private CreditPeople m_root;
            private CreditPeople m_parent;
            public int CreditPeopleId { get { return _creditPeopleId; } }
            public int CreditPeopleName { get { return _creditPeopleName; } }
            public int CreditRoleId { get { return _creditRoleId; } }
            public int OrderBy { get { return _orderBy; } }
            public CreditPeople M_Root { get { return m_root; } }
            public CreditPeople M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditPeople p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditPeople p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CreditPeople p__parent = null, CreditPeople p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditPeople p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CreditPeople p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
