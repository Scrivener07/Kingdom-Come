...
{
    public partial class ArmorType : KaitaiStruct
    {
        public static ArmorType FromFile(string fileName)
        {
            return new ArmorType(new KaitaiStream(fileName));
        }

        public ArmorType(KaitaiStream p__io, KaitaiStruct p__parent = null, ArmorType p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, ArmorType.Row p__parent = null, ArmorType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private ArmorType m_root;
            private ArmorType.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public ArmorType M_Root { get { return m_root; } }
            public ArmorType.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, ArmorType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, ArmorType p__parent = null, ArmorType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _armorTypeName = m_io.ReadS4le();
                _equipBuffId = new Uuid(m_io, this, m_root);
            }
            private int _armorTypeId;
            private int _armorTypeName;
            private Uuid _equipBuffId;
            private ArmorType m_root;
            private ArmorType m_parent;
            public int ArmorTypeId { get { return _armorTypeId; } }
            public int ArmorTypeName { get { return _armorTypeName; } }
            public Uuid EquipBuffId { get { return _equipBuffId; } }
            public ArmorType M_Root { get { return m_root; } }
            public ArmorType M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, ArmorType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, ArmorType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, ArmorType p__parent = null, ArmorType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, ArmorType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, ArmorType p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
