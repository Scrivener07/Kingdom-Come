...
{
    public partial class Recipe : KaitaiStruct
    {
        public static Recipe FromFile(string fileName)
        {
            return new Recipe(new KaitaiStream(fileName));
        }

        public Recipe(KaitaiStream p__io, KaitaiStruct p__parent = null, Recipe p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, Recipe.Row p__parent = null, Recipe p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private Recipe m_root;
            private Recipe.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public Recipe M_Root { get { return m_root; } }
            public Recipe.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, Recipe p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, Recipe p__parent = null, Recipe p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _productItemId = new Uuid(m_io, this, m_root);
                _baseMaterialId = new Uuid(m_io, this, m_root);
                _uiName = m_io.ReadS4le();
                _uiUsage = m_io.ReadS4le();
                _uiStats = m_io.ReadS4le();
                _maxYield = m_io.ReadS4le();
            }
            private int _recipeId;
            private Uuid _productItemId;
            private Uuid _baseMaterialId;
            private int _uiName;
            private int _uiUsage;
            private int _uiStats;
            private int _maxYield;
            private Recipe m_root;
            private Recipe m_parent;
            public int RecipeId { get { return _recipeId; } }
            public Uuid ProductItemId { get { return _productItemId; } }
            public Uuid BaseMaterialId { get { return _baseMaterialId; } }
            public int UiName { get { return _uiName; } }
            public int UiUsage { get { return _uiUsage; } }
            public int UiStats { get { return _uiStats; } }
            public int MaxYield { get { return _maxYield; } }
            public Recipe M_Root { get { return m_root; } }
            public Recipe M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, Recipe p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, Recipe p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, Recipe p__parent = null, Recipe p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, Recipe p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, Recipe p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
