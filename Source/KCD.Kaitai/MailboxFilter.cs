...
{
    public partial class MailboxFilter : KaitaiStruct
    {
        public static MailboxFilter FromFile(string fileName)
        {
            return new MailboxFilter(new KaitaiStream(fileName));
        }

        public MailboxFilter(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxFilter p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, MailboxFilter.Row p__parent = null, MailboxFilter p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private MailboxFilter m_root;
            private MailboxFilter.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public MailboxFilter M_Root { get { return m_root; } }
            public MailboxFilter.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxFilter p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, MailboxFilter p__parent = null, MailboxFilter p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _mailboxFilterId = new Uuid(m_io, this, m_root);
                _mailboxId = new Uuid(m_io, this, m_root);
                _type = m_io.ReadS4le();
            }
            private Uuid _mailboxFilterId;
            private Uuid _mailboxId;
            private int _type;
            private MailboxFilter m_root;
            private MailboxFilter m_parent;
            public Uuid MailboxFilterId { get { return _mailboxFilterId; } }
            public Uuid MailboxId { get { return _mailboxId; } }
            public int Type { get { return _type; } }
            public MailboxFilter M_Root { get { return m_root; } }
            public MailboxFilter M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxFilter p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxFilter p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, MailboxFilter p__parent = null, MailboxFilter p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxFilter p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxFilter p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
