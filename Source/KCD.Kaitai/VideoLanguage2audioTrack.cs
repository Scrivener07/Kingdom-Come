...
{
    public partial class VideoLanguage2audioTrack : KaitaiStruct
    {
        public static VideoLanguage2audioTrack FromFile(string fileName)
        {
            return new VideoLanguage2audioTrack(new KaitaiStream(fileName));
        }

        public VideoLanguage2audioTrack(KaitaiStream p__io, KaitaiStruct p__parent = null, VideoLanguage2audioTrack p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, VideoLanguage2audioTrack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private VideoLanguage2audioTrack m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public VideoLanguage2audioTrack M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, VideoLanguage2audioTrack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, VideoLanguage2audioTrack p__parent = null, VideoLanguage2audioTrack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _languageId = m_io.ReadS4le();
                _audioTrackId = m_io.ReadS4le();
                _subtitlesTrackId = m_io.ReadS4le();
            }
            private int _languageId;
            private int _audioTrackId;
            private int _subtitlesTrackId;
            private VideoLanguage2audioTrack m_root;
            private VideoLanguage2audioTrack m_parent;
            public int LanguageId { get { return _languageId; } }
            public int AudioTrackId { get { return _audioTrackId; } }
            public int SubtitlesTrackId { get { return _subtitlesTrackId; } }
            public VideoLanguage2audioTrack M_Root { get { return m_root; } }
            public VideoLanguage2audioTrack M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, VideoLanguage2audioTrack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, VideoLanguage2audioTrack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, VideoLanguage2audioTrack p__parent = null, VideoLanguage2audioTrack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, VideoLanguage2audioTrack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, VideoLanguage2audioTrack p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
