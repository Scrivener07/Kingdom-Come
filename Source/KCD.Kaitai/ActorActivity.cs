...
{
    public partial class ActorActivity : KaitaiStruct
    {
        public static ActorActivity FromFile(string fileName)
        {
            return new ActorActivity(new KaitaiStream(fileName));
        }

        public ActorActivity(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorActivity p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorActivity p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private ActorActivity m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public ActorActivity M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorActivity p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, ActorActivity p__parent = null, ActorActivity p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _actorActivityName = m_io.ReadS4le();
                _actorActivityMnTag = m_io.ReadS4le();
            }
            private int _actorActivityId;
            private int _actorActivityName;
            private int _actorActivityMnTag;
            private ActorActivity m_root;
            private ActorActivity m_parent;
            public int ActorActivityId { get { return _actorActivityId; } }
            public int ActorActivityName { get { return _actorActivityName; } }
            public int ActorActivityMnTag { get { return _actorActivityMnTag; } }
            public ActorActivity M_Root { get { return m_root; } }
            public ActorActivity M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorActivity p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorActivity p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, ActorActivity p__parent = null, ActorActivity p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorActivity p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorActivity p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
