...
{
    public partial class CombatDamageTypeMapping : KaitaiStruct
    {
        public static CombatDamageTypeMapping FromFile(string fileName)
        {
            return new CombatDamageTypeMapping(new KaitaiStream(fileName));
        }

        public CombatDamageTypeMapping(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatDamageTypeMapping p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatDamageTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private CombatDamageTypeMapping m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public CombatDamageTypeMapping M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatDamageTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, CombatDamageTypeMapping p__parent = null, CombatDamageTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _rWeaponSubClassId = m_io.ReadS4le();
            }
            private int _combatAttackTypeId;
            private int _rpgDamageTypeId;
            private int _rWeaponClassId;
            private int _rWeaponSubClassId;
            private CombatDamageTypeMapping m_root;
            private CombatDamageTypeMapping m_parent;
            ...
            public int RWeaponSubClassId { get { return _rWeaponSubClassId; } }
            public CombatDamageTypeMapping M_Root { get { return m_root; } }
            public CombatDamageTypeMapping M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatDamageTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatDamageTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, CombatDamageTypeMapping p__parent = null, CombatDamageTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatDamageTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, CombatDamageTypeMapping p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
