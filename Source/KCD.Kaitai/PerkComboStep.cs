...
{
    public partial class PerkComboStep : KaitaiStruct
    {
        public static PerkComboStep FromFile(string fileName)
        {
            return new PerkComboStep(new KaitaiStream(fileName));
        }

        public PerkComboStep(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkComboStep p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, PerkComboStep.Row p__parent = null, PerkComboStep p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private PerkComboStep m_root;
            private PerkComboStep.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public PerkComboStep M_Root { get { return m_root; } }
            public PerkComboStep.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkComboStep p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, PerkComboStep p__parent = null, PerkComboStep p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _comboId = m_io.ReadS4le();
                _comboStepId = m_io.ReadS4le();
            }
            private Uuid _perkId;
            private int _comboId;
            private int _comboStepId;
            private PerkComboStep m_root;
            private PerkComboStep m_parent;
            public Uuid PerkId { get { return _perkId; } }
            public int ComboId { get { return _comboId; } }
            public int ComboStepId { get { return _comboStepId; } }
            public PerkComboStep M_Root { get { return m_root; } }
            public PerkComboStep M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkComboStep p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkComboStep p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, PerkComboStep p__parent = null, PerkComboStep p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkComboStep p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkComboStep p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
