...
{
    public partial class PerkCompanion : KaitaiStruct
    {
        public static PerkCompanion FromFile(string fileName)
        {
            return new PerkCompanion(new KaitaiStream(fileName));
        }

        public PerkCompanion(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkCompanion p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, PerkCompanion.Row p__parent = null, PerkCompanion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private PerkCompanion m_root;
            private PerkCompanion.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public PerkCompanion M_Root { get { return m_root; } }
            public PerkCompanion.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkCompanion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, PerkCompanion p__parent = null, PerkCompanion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _companionTypeId = m_io.ReadS4le();
                _forwardPerkId = new Uuid(m_io, this, m_root);
            }
            private Uuid _perkId;
            private int _companionTypeId;
            private Uuid _forwardPerkId;
            private PerkCompanion m_root;
            private PerkCompanion m_parent;
            public Uuid PerkId { get { return _perkId; } }
            public int CompanionTypeId { get { return _companionTypeId; } }
            public Uuid ForwardPerkId { get { return _forwardPerkId; } }
            public PerkCompanion M_Root { get { return m_root; } }
            public PerkCompanion M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkCompanion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkCompanion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, PerkCompanion p__parent = null, PerkCompanion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkCompanion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, PerkCompanion p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
