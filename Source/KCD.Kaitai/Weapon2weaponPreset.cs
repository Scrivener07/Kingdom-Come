...
{
    public partial class Weapon2weaponPreset : KaitaiStruct
    {
        public static Weapon2weaponPreset FromFile(string fileName)
        {
            return new Weapon2weaponPreset(new KaitaiStream(fileName));
        }

        public Weapon2weaponPreset(KaitaiStream p__io, KaitaiStruct p__parent = null, Weapon2weaponPreset p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, Weapon2weaponPreset.Row p__parent = null, Weapon2weaponPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private Weapon2weaponPreset m_root;
            private Weapon2weaponPreset.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public Weapon2weaponPreset M_Root { get { return m_root; } }
            public Weapon2weaponPreset.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, Weapon2weaponPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, Weapon2weaponPreset p__parent = null, Weapon2weaponPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _weaponPresetId = new Uuid(m_io, this, m_root);
                _itemId = new Uuid(m_io, this, m_root);
                _amount = m_io.ReadS4le();
                _isEquipped = m_io.ReadS1();
            }
            private Uuid _weaponPresetId;
            private Uuid _itemId;
            private int _amount;
            private sbyte _isEquipped;
            private Weapon2weaponPreset m_root;
            private Weapon2weaponPreset m_parent;
            public Uuid WeaponPresetId { get { return _weaponPresetId; } }
            public Uuid ItemId { get { return _itemId; } }
            public int Amount { get { return _amount; } }
            public sbyte IsEquipped { get { return _isEquipped; } }
            public Weapon2weaponPreset M_Root { get { return m_root; } }
            public Weapon2weaponPreset M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, Weapon2weaponPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, Weapon2weaponPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, Weapon2weaponPreset p__parent = null, Weapon2weaponPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, Weapon2weaponPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, Weapon2weaponPreset p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
