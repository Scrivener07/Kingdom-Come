...
{
    public partial class ActorActionTypeGroup : KaitaiStruct
    {
        public static ActorActionTypeGroup FromFile(string fileName)
        {
            return new ActorActionTypeGroup(new KaitaiStream(fileName));
        }

        public ActorActionTypeGroup(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorActionTypeGroup p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorActionTypeGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private ActorActionTypeGroup m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public ActorActionTypeGroup M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorActionTypeGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, ActorActionTypeGroup p__parent = null, ActorActionTypeGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _actorActionTypeGroupId = m_io.ReadS4le();
                _actorActionTypeId = m_io.ReadS4le();
            }
            private int _actorActionTypeGroupId;
            private int _actorActionTypeId;
            private ActorActionTypeGroup m_root;
            private ActorActionTypeGroup m_parent;
            public int ActorActionTypeGroupId { get { return _actorActionTypeGroupId; } }
            public int ActorActionTypeId { get { return _actorActionTypeId; } }
            public ActorActionTypeGroup M_Root { get { return m_root; } }
            public ActorActionTypeGroup M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorActionTypeGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorActionTypeGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, ActorActionTypeGroup p__parent = null, ActorActionTypeGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorActionTypeGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, ActorActionTypeGroup p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
