...
{
    public partial class SocialClass : KaitaiStruct
    {
        public static SocialClass FromFile(string fileName)
        {
            return new SocialClass(new KaitaiStream(fileName));
        }

        public SocialClass(KaitaiStream p__io, KaitaiStruct p__parent = null, SocialClass p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, SocialClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private SocialClass m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public SocialClass M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, SocialClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, SocialClass p__parent = null, SocialClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                ...
                _socialClassName = m_io.ReadS4le();
                _wealth = m_io.ReadS4le();
                _soulCrimeRoleId = m_io.ReadS4le();
                _presetItemsHealthBase = m_io.ReadF4le();
                _presetItemsHealthRandom = m_io.ReadF4le();
            }
            private int _socialClassId;
            private int _socialClassName;
            private int _wealth;
            private int _soulCrimeRoleId;
            private float _presetItemsHealthBase;
            private float _presetItemsHealthRandom;
            private SocialClass m_root;
            private SocialClass m_parent;
            public int SocialClassId { get { return _socialClassId; } }
            public int SocialClassName { get { return _socialClassName; } }
            public int Wealth { get { return _wealth; } }
            public int SoulCrimeRoleId { get { return _soulCrimeRoleId; } }
            public float PresetItemsHealthBase { get { return _presetItemsHealthBase; } }
            public float PresetItemsHealthRandom { get { return _presetItemsHealthRandom; } }
            public SocialClass M_Root { get { return m_root; } }
            public SocialClass M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, SocialClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, SocialClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, SocialClass p__parent = null, SocialClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, SocialClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, SocialClass p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
