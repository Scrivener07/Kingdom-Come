...
{
    public partial class RichPresence : KaitaiStruct
    {
        public static RichPresence FromFile(string fileName)
        {
            return new RichPresence(new KaitaiStream(fileName));
        }

        public RichPresence(KaitaiStream p__io, KaitaiStruct p__parent = null, RichPresence p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, RichPresence p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private RichPresence m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public RichPresence M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, RichPresence p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, RichPresence p__parent = null, RichPresence p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _richPresenceId = m_io.ReadS4le();
                _nameStringId = m_io.ReadS4le();
                _xboxRichPresenceKey = m_io.ReadS4le();
            }
            private int _richPresenceId;
            private int _nameStringId;
            private int _xboxRichPresenceKey;
            private RichPresence m_root;
            private RichPresence m_parent;
            public int RichPresenceId { get { return _richPresenceId; } }
            public int NameStringId { get { return _nameStringId; } }
            public int XboxRichPresenceKey { get { return _xboxRichPresenceKey; } }
            public RichPresence M_Root { get { return m_root; } }
            public RichPresence M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, RichPresence p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, RichPresence p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, RichPresence p__parent = null, RichPresence p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, RichPresence p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, RichPresence p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
