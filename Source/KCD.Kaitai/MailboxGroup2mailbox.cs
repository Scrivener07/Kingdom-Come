...
{
    public partial class MailboxGroup2mailbox : KaitaiStruct
    {
        public static MailboxGroup2mailbox FromFile(string fileName)
        {
            return new MailboxGroup2mailbox(new KaitaiStream(fileName));
        }

        public MailboxGroup2mailbox(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxGroup2mailbox p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, MailboxGroup2mailbox.Row p__parent = null, MailboxGroup2mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private MailboxGroup2mailbox m_root;
            private MailboxGroup2mailbox.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public MailboxGroup2mailbox M_Root { get { return m_root; } }
            public MailboxGroup2mailbox.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxGroup2mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, MailboxGroup2mailbox p__parent = null, MailboxGroup2mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _mailboxGroupId = new Uuid(m_io, this, m_root);
                _mailboxId = new Uuid(m_io, this, m_root);
                _priority = m_io.ReadS4le();
            }
            private Uuid _mailboxGroupId;
            private Uuid _mailboxId;
            private int _priority;
            private MailboxGroup2mailbox m_root;
            private MailboxGroup2mailbox m_parent;
            public Uuid MailboxGroupId { get { return _mailboxGroupId; } }
            public Uuid MailboxId { get { return _mailboxId; } }
            public int Priority { get { return _priority; } }
            public MailboxGroup2mailbox M_Root { get { return m_root; } }
            public MailboxGroup2mailbox M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxGroup2mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxGroup2mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, MailboxGroup2mailbox p__parent = null, MailboxGroup2mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxGroup2mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, MailboxGroup2mailbox p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
