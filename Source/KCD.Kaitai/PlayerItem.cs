...
{
    public partial class PlayerItem : KaitaiStruct
    {
        public static PlayerItem FromFile(string fileName)
        {
            return new PlayerItem(new KaitaiStream(fileName));
        }

        public PlayerItem(KaitaiStream p__io, KaitaiStruct p__parent = null, PlayerItem p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, PlayerItem.Row p__parent = null, PlayerItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private PlayerItem m_root;
            private PlayerItem.Row m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public PlayerItem M_Root { get { return m_root; } }
            public PlayerItem.Row M_Parent { get { return m_parent; } }
        }
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, PlayerItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, PlayerItem p__parent = null, PlayerItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private int _uiInfo;
            private PlayerItem m_root;
            private PlayerItem m_parent;
            public Uuid ItemId { get { return _itemId; } }
            public int IconId { get { return _iconId; } }
            public int UiName { get { return _uiName; } }
            public int UiInfo { get { return _uiInfo; } }
            public PlayerItem M_Root { get { return m_root; } }
            public PlayerItem M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, PlayerItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, PlayerItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, PlayerItem p__parent = null, PlayerItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, PlayerItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, PlayerItem p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
