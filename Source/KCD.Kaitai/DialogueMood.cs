...
{
    public partial class DialogueMood : KaitaiStruct
    {
        public static DialogueMood FromFile(string fileName)
        {
            return new DialogueMood(new KaitaiStream(fileName));
        }

        public DialogueMood(KaitaiStream p__io, KaitaiStruct p__parent = null, DialogueMood p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        public partial class Uuid : KaitaiStruct
        {
            ...
            public Uuid(KaitaiStream p__io, KaitaiStruct p__parent = null, DialogueMood p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private DialogueMood m_root;
            private KaitaiStruct m_parent;
            public byte[] UuidType { get { return _uuidType; } }
            public DialogueMood M_Root { get { return m_root; } }
        ...
        public partial class Trifloat : KaitaiStruct
        {
            ...
            public Trifloat(KaitaiStream p__io, KaitaiStruct p__parent = null, DialogueMood p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Row : KaitaiStruct
        {
            ...
            public Row(KaitaiStream p__io, DialogueMood p__parent = null, DialogueMood p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
            ...
            private void _read()
            {
                _dialogueMoodId = m_io.ReadS4le();
                _dialogueMoodName = m_io.ReadS4le();
                _tagName = m_io.ReadS4le();
            }
            private int _dialogueMoodId;
            private int _dialogueMoodName;
            private int _tagName;
            private DialogueMood m_root;
            private DialogueMood m_parent;
            public int DialogueMoodId { get { return _dialogueMoodId; } }
            public int DialogueMoodName { get { return _dialogueMoodName; } }
            public int TagName { get { return _tagName; } }
            public DialogueMood M_Root { get { return m_root; } }
            public DialogueMood M_Parent { get { return m_parent; } }
        }
        public partial class Quat : KaitaiStruct
        {
            ...
            public Quat(KaitaiStream p__io, KaitaiStruct p__parent = null, DialogueMood p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Quatt : KaitaiStruct
        {
            ...
            public Quatt(KaitaiStream p__io, KaitaiStruct p__parent = null, DialogueMood p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Header : KaitaiStruct
        {
            ...
            public Header(KaitaiStream p__io, DialogueMood p__parent = null, DialogueMood p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Vec3 : KaitaiStruct
        {
            ...
            public Vec3(KaitaiStream p__io, KaitaiStruct p__parent = null, DialogueMood p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
        ...
        public partial class Padding : KaitaiStruct
        {
            ...
            public Padding(KaitaiStream p__io, KaitaiStruct p__parent = null, DialogueMood p__root = null) : base(p__io)
            {
                m_parent = p__parent;
                m_root = p__root;
                _read();
